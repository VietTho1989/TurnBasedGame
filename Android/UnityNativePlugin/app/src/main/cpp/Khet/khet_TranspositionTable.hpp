#ifndef __KHET_TRANSPOSITION_TABLE_H__
#define __KHET_TRANSPOSITION_TABLE_H__
...
namespace Khet
{
    ...
    public:
        ...
        void Insert(Key key, EntryType type, Move move, int32_t depth, int32_t value)
        {
