...
namespace StockFishChess
{
    ...
    namespace {
        ...
        inline WDLScore operator-(WDLScore d) { return WDLScore(-int32_t(d)); }
        ...
        struct LR {
            ...
            Sym get() {
                ...
                S == Value ?   lr[0] : (printf("error, assert(false)\n"), Sym(-1));
            }
        };
        ...
        bool check_dtz_stm(WDLEntry*, int32_t, File) { return true; }
        ...
        T do_probe_table(const Position& pos, Entry* entry, WDLScore wdl, ProbeState* result) {
            ...
            if (entry->hasPawns) {
                ...
                std::swap(squares[0], *max_element(squares, squares + leadPawnsCnt, pawns_comp));
        ...
        template<typename T>
        void set_groups(T& e, PairsData* d, int32_t order[], File f) {
