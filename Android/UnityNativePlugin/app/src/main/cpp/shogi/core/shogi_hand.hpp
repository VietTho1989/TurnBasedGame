...
namespace Shogi {
    ...
    public:
        ...
        // num が int だけどまあ良いか。
        void orEqual(const int32_t num, const HandPiece handPiece) { value_ |= num << HandPieceShiftBits[handPiece]; }
    ...
    private:
        static const int32_t HPawnShiftBits   =  0;
        static const int32_t HLanceShiftBits  =  6;
        static const int32_t HKnightShiftBits = 10;
        static const int32_t HSilverShiftBits = 14;
        static const int32_t HGoldShiftBits   = 18;
        static const int32_t HBishopShiftBits = 22;
        static const int32_t HRookShiftBits   = 25;
        ...
        static const int32_t HandPieceShiftBits[HandPieceNum];
