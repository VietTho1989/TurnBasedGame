...
#ifndef FAIRY_CHESS_TYPES_HPP_INCLUDED
#define FAIRY_CHESS_TYPES_HPP_INCLUDED
...
#  define pext(b, m) 0
    ...
    constexpr int32_t MAX_MOVES = 512;
    ...
    const int32_t PIECE_TYPE_BITS = 5; // PIECE_TYPE_NB = pow(2, PIECE_TYPE_BITS)
...
constexpr T operator-(T d1, T d2) { return T(int(d1) - int32_t(d2)); } \
