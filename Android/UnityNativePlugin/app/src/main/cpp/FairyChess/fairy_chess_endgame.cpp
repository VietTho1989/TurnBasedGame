...
#include "fairy_chess_endgame.hpp"
...
namespace FairyChess
{
    namespace {
        ...
        constexpr int32_t PushToEdges[SQUARE_NB] = {
        ...
        constexpr int32_t PushToCorners[SQUARE_NB] = {
        ...
        constexpr int32_t PushClose[8] = { 0, 0, 100, 80, 60, 40, 20, 10 };
        constexpr int32_t PushAway [8] = { 0, 5, 20, 40, 60, 80, 90, 100 };
        ...
        Square normalize(Position* pos, Color strongSide, Square sq) {
    ...
    template<> Value Endgame<KXK>::operator()(Position* pos) const {
    ...
    template<> Value Endgame<KBNK>::operator()(Position* pos) const {
    ...
    template<> Value Endgame<KPK>::operator()(Position* pos) const {
    ...
    /// away.
    template<> Value Endgame<KRKP>::operator()(Position* pos) const {
    ...
    template<> Value Endgame<KRKB>::operator()(Position* pos) const {
    ...
    template<> Value Endgame<KRKN>::operator()(Position* pos) const {
    ...
    template<> Value Endgame<KQKP>::operator()(Position* pos) const {
    ...
    template<> Value Endgame<KQKR>::operator()(Position* pos) const {
    ...
    template<> Value Endgame<KNNK>::operator()(Position*) const { return VALUE_DRAW; }
    ...
    /// will be used.
    template<> ScaleFactor Endgame<KBPsK>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KQKRPs>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KRPKR>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KRPKB>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KRPPKRP>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KPsK>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KBPKB>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KBPPKB>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KBPKN>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KNPK>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KNPKB>::operator()(Position* pos) const {
    ...
    template<> ScaleFactor Endgame<KPKP>::operator()(Position* pos) const {
