...
namespace Seirawan
{
    ...
    namespace {
        ...
        private:
            ...
            int32_t king_distance(Color c, Square s);
...
#define S(mg, eg) make_score(mg, eg)
        ...
        const int32_t RankFactor[RANK_NB] = {0, 0, 0, 2, 6, 11, 16};
...
#undef V
        ...
        const int32_t KingAttackWeights[PIECE_TYPE_NB] = { 0, 0, 78, 56, 45, 10, 10, 11 };
        
        // Penalties for enemy's safe checks
        const int32_t QueenSafeCheck    = 780;
        const int32_t ElephantSafeCheck = 780;
        const int32_t HawkSafeCheck     = 780;
        ...
        template<Tracing T> int32_t Evaluation<T>::king_distance(Color c, Square s) {
