...
struct  SocketIOEventTypes_t2290781438 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SocketIOEventTypes_t2290781438, ___value___1)); }
