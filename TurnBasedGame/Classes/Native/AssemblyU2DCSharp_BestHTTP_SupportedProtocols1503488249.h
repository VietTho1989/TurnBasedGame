...
struct  SupportedProtocols_t1503488249 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SupportedProtocols_t1503488249, ___value___1)); }
