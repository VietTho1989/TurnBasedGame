...
struct  HTTPConnectionStates_t1509261476 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(HTTPConnectionStates_t1509261476, ___value___1)); }
