...
struct  BerSequenceParser_t1792950261  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of__parser_0() { return static_cast<int32_t>(offsetof(BerSequenceParser_t1792950261, ____parser_0)); }
