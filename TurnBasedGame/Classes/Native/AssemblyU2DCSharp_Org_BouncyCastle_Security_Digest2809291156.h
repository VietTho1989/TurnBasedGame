...
struct  DigestAlgorithm_t2809291156 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DigestAlgorithm_t2809291156, ___value___1)); }
