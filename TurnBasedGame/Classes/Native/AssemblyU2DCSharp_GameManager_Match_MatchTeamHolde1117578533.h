...
struct  UIData_t1117578533  : public BaseItemViewsHolder_t1196055060
{
public:
	// VP`1<ReferenceData`1<GameManager.Match.MatchTeam>> GameManager.Match.MatchTeamHolder/UIData::matchTeam
	VP_1_t2828631739 * ___matchTeam_8;

public:
	inline static int32_t get_offset_of_matchTeam_8() { return static_cast<int32_t>(offsetof(UIData_t1117578533, ___matchTeam_8)); }
