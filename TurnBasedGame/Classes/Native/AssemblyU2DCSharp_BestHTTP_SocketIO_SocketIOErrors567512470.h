...
struct  SocketIOErrors_t567512470 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SocketIOErrors_t567512470, ___value___1)); }
