...
struct  CoTuongUpMove_t185374601  : public GameMove_t1861898997
{
public:
...
public:
	inline static int32_t get_offset_of_move_5() { return static_cast<int32_t>(offsetof(CoTuongUpMove_t185374601, ___move_5)); }
