...
struct  EveryOneNotBanObserver_t344291683  : public CheckChange_t811089867
{
public:
...
public:
	inline static int32_t get_offset_of_data_1() { return static_cast<int32_t>(offsetof(EveryOneNotBanObserver_t344291683, ___data_1)); }
