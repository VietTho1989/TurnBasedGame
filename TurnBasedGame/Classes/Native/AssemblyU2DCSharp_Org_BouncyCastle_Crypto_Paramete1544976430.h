...
struct  DHPublicKeyParameters_t1544976430  : public DHKeyParameters_t508500971
{
public:
...
public:
	inline static int32_t get_offset_of_y_3() { return static_cast<int32_t>(offsetof(DHPublicKeyParameters_t1544976430, ___y_3)); }
