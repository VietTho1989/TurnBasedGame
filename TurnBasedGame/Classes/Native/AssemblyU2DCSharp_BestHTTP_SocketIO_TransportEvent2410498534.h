...
struct  TransportEventTypes_t2410498534 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TransportEventTypes_t2410498534, ___value___1)); }
