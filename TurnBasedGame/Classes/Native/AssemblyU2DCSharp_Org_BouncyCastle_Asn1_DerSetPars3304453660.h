...
struct  DerSetParser_t3304453660  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of__parser_0() { return static_cast<int32_t>(offsetof(DerSetParser_t3304453660, ____parser_0)); }
