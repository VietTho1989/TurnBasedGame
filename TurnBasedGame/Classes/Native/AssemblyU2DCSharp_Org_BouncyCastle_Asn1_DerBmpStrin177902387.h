...
struct  DerBmpString_t177902387  : public DerStringBase_t1343648701
{
public:
...
public:
	inline static int32_t get_offset_of_str_2() { return static_cast<int32_t>(offsetof(DerBmpString_t177902387, ___str_2)); }
