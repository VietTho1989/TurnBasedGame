...
struct  AuthenticationTypes_t1276453517 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AuthenticationTypes_t1276453517, ___value___1)); }
