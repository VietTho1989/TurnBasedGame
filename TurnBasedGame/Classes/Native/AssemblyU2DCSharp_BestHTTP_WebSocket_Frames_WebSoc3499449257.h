...
struct  WebSocketFrameTypes_t3499449257 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(WebSocketFrameTypes_t3499449257, ___value___1)); }
