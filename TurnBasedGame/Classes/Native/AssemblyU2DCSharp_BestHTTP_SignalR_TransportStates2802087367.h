...
struct  TransportStates_t2802087367 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TransportStates_t2802087367, ___value___1)); }
