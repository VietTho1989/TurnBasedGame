...
struct  RemovePlayerCommand_t3699333100  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_Player_0() { return static_cast<int32_t>(offsetof(RemovePlayerCommand_t3699333100, ___Player_0)); }
