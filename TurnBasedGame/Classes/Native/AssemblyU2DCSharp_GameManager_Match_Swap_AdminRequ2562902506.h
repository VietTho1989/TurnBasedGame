...
struct  UIData_t2562902506  : public BaseItemViewsHolder_t1196055060
{
public:
	// VP`1<ReferenceData`1<Human>> GameManager.Match.Swap.AdminRequestSwapPlayerChooseHumanHolder/UIData::human
	VP_1_t605148562 * ___human_8;
	// VP`1<AccountAvatarUI/UIData> GameManager.Match.Swap.AdminRequestSwapPlayerChooseHumanHolder/UIData::avatar
	VP_1_t3547432187 * ___avatar_9;

public:
	inline static int32_t get_offset_of_human_8() { return static_cast<int32_t>(offsetof(UIData_t2562902506, ___human_8)); }
	...
	inline static int32_t get_offset_of_avatar_9() { return static_cast<int32_t>(offsetof(UIData_t2562902506, ___avatar_9)); }
