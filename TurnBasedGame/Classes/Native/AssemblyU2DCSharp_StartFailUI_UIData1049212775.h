...
// StartFailUI/UIData
struct  UIData_t1049212775  : public Sub_t4277966041
{
public:
	// VP`1<ReferenceData`1<Server>> StartFailUI/UIData::server
	VP_1_t2173380836 * ___server_5;

public:
	inline static int32_t get_offset_of_server_5() { return static_cast<int32_t>(offsetof(UIData_t1049212775, ___server_5)); }
