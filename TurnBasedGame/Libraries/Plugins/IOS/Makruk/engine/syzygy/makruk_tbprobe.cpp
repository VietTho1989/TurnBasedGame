...
#include "../makruk_thread_win32.hpp"
#include "../makruk_types.hpp"

#include "makruk_tbprobe.hpp"
...
namespace Makruk
{
    ...
    namespace {
        ...
        inline Square operator^(Square s, int32_t i) { return Square(int(s) ^ i); }
        ...
        struct LR {
            ...
            template<Side S> Sym get()
            {
                ...
                S == Value ?   lr[0] : (assert(true), Sym(-1));
            }
        };
