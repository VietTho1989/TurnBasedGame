...
#ifndef CHESS_STOCK_FISH_TIMEMAN_H_INCLUDED
#define CHESS_STOCK_FISH_TIMEMAN_H_INCLUDED
...
namespace StockFishChess
{
    ...
    public:
        ...
        int32_t optimum() const { return optimumTime; }
        int32_t maximum() const { return maximumTime; }
        
        int32_t elapsed() const
        {
            return int32_t(now() - startTime);
        }
