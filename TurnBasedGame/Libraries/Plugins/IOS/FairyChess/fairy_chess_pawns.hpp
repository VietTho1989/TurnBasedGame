...
#ifndef FAIRY_CHESS_PAWNS_HPP_INCLUDED
#define FAIRY_CHESS_PAWNS_HPP_INCLUDED
...
namespace FairyChess
{
    namespace Pawns {
        ...
        struct Entry {
            ...
            template<Color Us> Score king_safety(Position* pos, Square ksq) {
                return  kingSquares[Us] == ksq && castlingRights[Us] == pos->can_castle(Us)
                ? kingSafety[Us] : (kingSafety[Us] = do_king_safety<Us>(pos, ksq));
            }
            
            template<Color Us> Score do_king_safety(Position* pos, Square ksq);
            
            template<Color Us> Value evaluate_shelter(Position* pos, Square ksq);
