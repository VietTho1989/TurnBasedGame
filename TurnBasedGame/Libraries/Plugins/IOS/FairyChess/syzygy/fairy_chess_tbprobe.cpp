...
#include "../fairy_chess_thread_win32.hpp"
#include "../fairy_chess_types.hpp"
#include "../fairy_chess_uci.hpp"

#include "fairy_chess_tbprobe.hpp"
...
namespace FairyChess
{
    ...
    namespace {
        ...
        constexpr int32_t TBPIECES = 6; // Max number of supported pieces
        ...
        struct TBTable {
            ...
            static constexpr int32_t Sides = Type == WDL ? 2 : 1;
            ...
            PairsData* get(int32_t stm, int32_t f) {
        ...
        class TBTables {
            ...
            static const int32_t Size = 1 << 12; // 4K table, indexed by key's 12 lsb
        ...
        bool check_dtz_stm(TBTable<WDL>*, int32_t, File) { return true; }
        
        bool check_dtz_stm(TBTable<DTZ>* entry, int32_t stm, File f) {
        ...
        WDLScore map_score(TBTable<WDL>*, File, int32_t value, WDLScore) { return WDLScore(value - 2); }

        int32_t map_score(TBTable<DTZ>* entry, File f, int32_t value, WDLScore wdl) {
        ...
        Ret do_probe_table(Position* pos, T* entry, WDLScore wdl, ProbeState* result) {
        ...
        template<typename T> void set(T& e, uint8_t* data) {
            ...
            const int32_t sides = T::Sides == 2 && (e.key != e.key2) ? 2 : 1;
            ...
            if(!(!pp || e.pawnCount[0])){
                printf("error, assert(!pp || e.pawnCount[0])\n");
            }
        ...
        template<TBType Type> void* mapped(TBTable<Type>& e, Position* pos) {
        ...
        Ret probe_table(Position* pos, ProbeState* result, WDLScore wdl = WDLDraw) {
    ...
    int32_t Tablebases::probe_dtz(Position* pos, ProbeState* result) {
        ...
        *result = OK;
        ...
        int32_t dtz = probe_table<DTZ>(pos, result, wdl);
    ...
    bool Tablebases::root_probe(Position* pos, Search::RootMoves& rootMoves) {
        ...
        int32_t cnt50 = pos->rule50_count();
        
        // Check whether a position was repeated since the last zeroing move.
        bool rep = pos->has_repeated();

        int32_t dtz, bound = Options["Syzygy50MoveRule"] ? 900 : 1;
        ...
        for (auto& m : rootMoves)
        {
            ...
            int32_t r =  dtz > 0 ? (dtz + cnt50 <= 99 && !rep ? 1000 : 1000 - (dtz + cnt50))
            ...
            : r >  0     ? Value((max( 3, r - 800) * int(PawnValueEg)) / 200)
            : r == 0     ? VALUE_DRAW
            : r > -bound ? Value((min(-3, r + 800) * int(PawnValueEg)) / 200)
            :             -VALUE_MATE + MAX_PLY + 1;
        }
    ...
    bool Tablebases::root_probe_wdl(Position* pos, Search::RootMoves& rootMoves) {
        ...
        static const int32_t WDL_to_rank[] = { -1000, -899, 0, 899, 1000 };
