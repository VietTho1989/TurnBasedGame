...
namespace Shogi {
    ...
    public:
        ...
        int32_t optimum() const { return optimumTime_; }
        int32_t maximum() const { return maximumTime_; }
        int32_t elapsed() const { return startTime_.elapsed(); }
        
    private:
        Timer startTime_;
        int32_t optimumTime_;
        int32_t maximumTime_;
    };
}
