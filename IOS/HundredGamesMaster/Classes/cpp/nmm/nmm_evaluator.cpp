...
namespace NMM
{
    static const int32_t ADJACENCY[24] = {	1,			2,			1,
        1,		3,		1,
        1, 2, 1,
        2,  3,   2,	   2,   3,	2,
        1, 2, 1,
    ...
    void Evaluator::set_evaluation_weight(int32_t positioning[6], int32_t playing[7], int32_t flying[4])
    {
    ...
    int32_t Evaluator::morrises_number(const Board &b, const SpotStatus &ss)
    {
        int32_t num_morris = 0;
    ...
    int32_t Evaluator::blocked_opp_pieces(const Board &b, const SpotStatus &ss)
    {
        int32_t blocked = 0;
        for(int32_t i = 0; i < BOARD_SPOT; i++)
    ...
    int32_t Evaluator::difference_pieces_positioning(const Board &b, const bool &white_turn)
    {
        int32_t my_pieces = 0;
        int32_t opp_pieces = 0;
    ...
    int32_t Evaluator::difference_pieces(const Board &b, const bool &white_turn)
    {
        int32_t my_pieces = white_turn ? b.num_white_pieces : b.num_black_pieces;
        int32_t opp_pieces = white_turn ? b.num_black_pieces : b.num_white_pieces;
        
        return my_pieces - opp_pieces;
    }
    
    int32_t Evaluator::number_2pieces(const Board &b, const SpotStatus &ss)
    {
        int32_t conf_2pieces = 0;
        for(int32_t i = 0; i < BOARD_SPOT; i++) {
            // verifica se forma uma conf 2 na horizontal
    ...
    int32_t Evaluator::number_3pieces(const Board &b, const SpotStatus &ss)
    {
    ...
    int32_t Evaluator::opened_morris(const Board &b, const SpotStatus &ss)
    {
        int32_t open = 0;
        for(int32_t i = 0; i < BOARD_SPOT; i++) {
            // verifica se forma uma conf 2 na horizontal
    ...
    int32_t Evaluator::double_morris(const Board &b, const SpotStatus &ss)
    {
    ...
    int32_t Evaluator::is_winning_state(const Board &b, const SpotStatus &ss)
    {
