...
#ifndef XIANGQI_PGNFILE_H
#define XIANGQI_PGNFILE_H

namespace Xiangqi
{
    
    const int32_t MAX_STR_LEN = 256;
    const int32_t MAX_MOVE_LEN = 1999;
    const int32_t MAX_COUNTER = 1000;
    const int32_t MAX_REM_LEN = 4096;
