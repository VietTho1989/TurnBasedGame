...
namespace Seirawan
{
    ...
    namespace {
        ...
        const int32_t razor_margin = 600;
    ...
    void Thread::search() {
        ...
        while (   (rootDepth += ONE_PLY) < DEPTH_MAX
            ...
            for (PVIdx = 0; PVIdx < multiPV && !stop; ++PVIdx) {
                ...
                // high/low anymore.
                while (true) {
                    bestValue = Seirawan::search<PV>(rootPos, ss, alpha, beta, rootDepth, false, false);
            ...
            if(rootMoves.size()>0){
                ...
                printf("why don't have rootMove, may be mate\n");
            }
    ...
    namespace {
        ...
        template <NodeType NT> Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode, bool skipEarlyPruning) {
            ...
            if (   !PvNode
                ...
                && (ss->ply >= pos.thisThread->nmp_ply || ss->ply % 2 != pos.thisThread->nmp_odd))
            {
                ...
                &&  abs(beta) < VALUE_MATE_IN_MAX_PLY)
            {
                ...
                MovePicker mp(pos, ttMove, rbeta - ss->staticEval, &pos.thisThread->captureHistory);
