...
namespace Shogi
{
    ...
    const int32_t RookBlockBits[SquareNum] = {
    ...
    const int32_t BishopBlockBits[SquareNum] = {
        7,  6,  6,  6,  6,  6,  6,  6,  7,
        6,  6,  6,  6,  6,  6,  6,  6,  6,
        6,  6,  8,  8,  8,  8,  8,  6,  6,
    ...
    const int32_t RookShiftBits[SquareNum] = {
    ...
    // Magic Bitboard で利きを求める際のシフト量
    const int32_t BishopShiftBits[SquareNum] = {
...
#endif
    int32_t RookAttackIndex[SquareNum];
    Bitboard RookBlockMask[SquareNum];
    Bitboard BishopAttack[20224];
    int32_t BishopAttackIndex[SquareNum];
