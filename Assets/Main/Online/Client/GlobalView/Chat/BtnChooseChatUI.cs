...
public class BtnChooseChatUI : UIBehavior<BtnChooseChatUI.UIData>
{
	...
	public static readonly TxtLanguage txtGeneral = new TxtLanguage();
	public static readonly TxtLanguage txtShortQuestion = new TxtLanguage();
	public static readonly TxtLanguage txtBug = new TxtLanguage ();
	public static readonly TxtLanguage txtSuggestion = new TxtLanguage();
	public static readonly TxtLanguage txtOff = new TxtLanguage ();
	public static readonly TxtLanguage txtFriend = new TxtLanguage();
	public static readonly TxtLanguage txtGuild = new TxtLanguage();
	public static readonly TxtLanguage txtRoom = new TxtLanguage();
					...
					if (txtTopic != null) {
						...
						if (topic != null) {
							...
							case Topic.Type.General:
								txtTopic.text = txtGeneral.get ("General");
								break;
							case Topic.Type.ShortQuestion:
								txtTopic.text = txtShortQuestion.get ("Short Question");
								break;
							case Topic.Type.Bug:
								txtTopic.text = txtBug.get ("Bug");
								break;
							case Topic.Type.Suggestion:
								txtTopic.text = txtSuggestion.get ("Suggestion");
								break;
							case Topic.Type.Off:
								txtTopic.text = txtOff.get ("Off");
								break;
							case Topic.Type.Friend:
								txtTopic.text = txtFriend.get ("Friend");
								break;
							case Topic.Type.Guild:
								txtTopic.text = txtGuild.get ("Guild");
								break;
							case Topic.Type.Room:
								txtTopic.text = txtRoom.get ("Room");
								break;
							default:
