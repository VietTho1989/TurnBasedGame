...
public class RoomAdminBtnDeleteUI : UIBehavior<RoomAdminBtnDeleteUI.UIData>
{
            ...
            bool isProcess = false;
            {
                ...
                if (!isProcess)
                {
                    if (InputEvent.isBackEvent(e))
                    {
                        ...
                        {
                            roomAdminBtnDeleteUI.onClickBtnCancel();
                            isProcess = true;
                        }
                        else
                        {
    ...
    {
        txtTitle.add(Language.Type.vi, "Xác Nhận Kết Thúc Phòng");
        ...
        // btn
        {
            ...
            txtDeleteRoom.add(Language.Type.vi, "Kết Thúc");
            txtCancelDelete.add(Language.Type.vi, "Huỷ");
            txtDeletingRoom.add(Language.Type.vi, "Đang kết thúc");
            txtCannotDelete.add(Language.Type.vi, "Không thể kết thúc");
        }
    }
        ...
        if (dirty)
        {
            ...
            if (this.data != null)
            {
                ...
                if (room != null)
                {
                    // delete
                    {
                        bool isCanEnd = room.isCanEndRoom(Server.getProfileUserId(room));
                        // Process
                        if (isCanEnd)
                        {
                            // Task
