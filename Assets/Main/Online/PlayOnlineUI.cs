...
public class PlayOnlineUI : UIBehavior<PlayOnlineUI.UIData>
{
	...
	public ClientUI clientUIPrefab = null;
		...
		if (data is UIData.Sub) {
			...
			// UI
			{
				...
				case PlayOnlineUI.UIData.Sub.Type.Client:
					{
						ClientUI.UIData clientUIData = sub as ClientUI.UIData;
						UIUtils.Instantiate (clientUIData, clientUIPrefab, this.transform);
					}
					break;
		...
		if (data is UIData.Sub) {
			...
			// UI
			{
				...
				case PlayOnlineUI.UIData.Sub.Type.Client:
					{
						ClientUI.UIData clientUIData = sub as ClientUI.UIData;
						clientUIData.removeCallBackAndDestroy (typeof(ClientUI));
					}
					break;
				case PlayOnlineUI.UIData.Sub.Type.Server:
					{
