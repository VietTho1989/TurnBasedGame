...
public class ViewSaveGameHistoryUI : UIBehavior<ViewSaveGameHistoryUI.UIData>
{
	...
	public static readonly TxtLanguage txtCannotBack = new TxtLanguage();

	public static readonly TxtLanguage txtNext = new TxtLanguage();
	public static readonly TxtLanguage txtCannotNext = new TxtLanguage();

	public Text tvHistoryNotLoad;
	public static readonly TxtLanguage txtHistoryNotLoad = new TxtLanguage ();
			...
			if (this.data != null) {
				...
				// txt
				{
					if (tvHistoryNotLoad != null) {
						tvHistoryNotLoad.text = txtHistoryNotLoad.get ("History Not Load");
					} else {
