...
namespace Record
{
    public class ViewRecordControllerUI : UIBehavior<ViewRecordControllerUI.UIData>
    {
        ...
        public Text lbSpeed;
        public static readonly TxtLanguage txtSpeed = new TxtLanguage("Speed");

        public Text lbTime;
        public static readonly TxtLanguage txtTime = new TxtLanguage("Time");
