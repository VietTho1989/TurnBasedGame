...
public class DataUtils
{
	...
	public static void writeBinary<T>(BinaryWriter writer, T value)
	{
		...
		// chatMessage
		if (value is ChatNormalContent.Message) {
			ChatNormalContent.Message message = (ChatNormalContent.Message)(object)value;
			{
	...
	public static T readBinary<T>(BinaryReader reader)
	{
		...
		// chatMessage
		if (typeof(T) ==  typeof(ChatNormalContent.Message)) {
