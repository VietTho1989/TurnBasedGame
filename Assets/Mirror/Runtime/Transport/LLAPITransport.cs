...
namespace Mirror
{
    ...
    public class LLAPITransport : TransportLayer
    {
        ...
        public const int MaxBufferSize = 32768;// 4096
        ...
        readonly byte[] clientReceiveBuffer = new byte[MaxBufferSize];

        int serverHostId = -1;
        readonly byte[] serverReceiveBuffer = new byte[MaxBufferSize];
        ...
        public LLAPITransport(GlobalConfig globalConfig = null, ConnectionConfig connectionConfig = null)
        {
            ...
            if (globalConfig == null)
            {
                ...
                globalConfig.ReactorMaximumSentMessages = MaxBufferSize;
                globalConfig.ReactorMaximumReceivedMessages = MaxBufferSize;
                globalConfig.MaxPacketSize = 30000;// 2000;
        ...
        public const int DefaultServerMaxConnections = 2000;

#elif UNITY_IPHONE

    public const int DefaultServerMaxConnections = 100;
