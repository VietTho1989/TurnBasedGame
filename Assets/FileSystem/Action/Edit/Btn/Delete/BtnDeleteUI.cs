...
namespace FileSystem
{
	public class BtnDeleteUI : UIBehavior<BtnDeleteUI.UIData>
	{
		...
		public static readonly TxtLanguage txtCannotDeleteNotSelect = new TxtLanguage ();
		public static readonly TxtLanguage txtDeleting = new TxtLanguage();

		public static readonly TxtLanguage txtDeletingFile = new TxtLanguage();
		public static readonly TxtLanguage txtCancel = new TxtLanguage();
		public static readonly TxtLanguage txtDeletingCancel = new TxtLanguage();

		public static readonly TxtLanguage txtDeleteSuccess = new TxtLanguage();

		public static readonly TxtLanguage txtDeleteFile = new TxtLanguage();
		public static readonly TxtLanguage txtFail = new TxtLanguage();
		public static readonly TxtLanguage txtDeleteFail = new TxtLanguage();

		public static readonly TxtLanguage txtCannotDeleteDoingOtherAction = new TxtLanguage ();
														...
														// set
														{
															...
															// txt
															{
																...
																if (file != null) {
																	...
																	tvDelete.text = txtDeletingFile.get ("Deleting") + " " + file.Name + " (" + percent + "), " + txtCancel.get ("cancel") + "?";
																} else {
																	tvDelete.text = txtDeletingCancel.get ("Deleting, cancel?");
																}
															}
														}
													}
												...
												case ActionEdit.State.Type.Fail:
													{
														...
														// Set
														{
															...
															// txt
															{
																...
																// Process
																if (failFile != null) {
																	tvDelete.text = txtDeleteFile.get ("Delete") + " " + failFile.Name + " " + txtFail.get ("fail");
																} else {
																	Debug.LogError ("failFile null: " + this);
																	tvDelete.text = txtDeleteFail.get ("Delete fail");
																}
															}
														}
													}
