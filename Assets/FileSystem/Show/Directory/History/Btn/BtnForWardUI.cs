...
namespace FileSystem
{
	public class BtnForWardUI : UIBehavior<BtnForWardUI.UIData>
	{
		...
		public static readonly TxtLanguage txtCannotForward = new TxtLanguage();
		public static readonly TxtLanguage txtForward = new TxtLanguage();

		static BtnForWardUI()
		{
			txtCannotForward.add (Language.Type.vi, "Không thể tiến lên");
			txtForward.add (Language.Type.vi, "Tiến Lên");
		}

		#endregion

		public Button btnForWard;
		public Text tvForWard;
				...
				if (this.data != null) {
					...
					if (directoryHistory != null) {
						if (btnForWard != null && tvForWard != null) {
							...
							Debug.LogError ("btnForWard, tvForWard null: " + this);
						}
					} else {
