...
namespace FileSystem
{
    public class BtnBackWardUI : UIBehavior<BtnBackWardUI.UIData>
    {
        ...
        public override void Awake()
        {
            ...
            // OnClick
            {
                UIUtils.SetButtonOnClick(btnBackWard, onClickBtnBackWard);
            }
        }
            ...
            bool isProcess = false;
            {
                if (e.isKey && e.type == EventType.KeyUp)
                {
                    switch (e.keyCode)
                    {
                        case KeyCode.B:
                            {
                                if (btnBackWard != null && btnBackWard.gameObject.activeInHierarchy && btnBackWard.interactable)
                                {
                                    this.onClickBtnBackWard();
                                    isProcess = true;
                                }
                                else
                                {
