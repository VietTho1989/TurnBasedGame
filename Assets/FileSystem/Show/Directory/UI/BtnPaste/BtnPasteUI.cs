...
namespace FileSystem
{
    public class BtnPasteUI : UIBehavior<BtnPasteUI.UIData>
    {
        ...
        private static readonly TxtLanguage txtPaste = new TxtLanguage("Paste");
        private static readonly TxtLanguage txtCannotPaste = new TxtLanguage("Paste");
                        ...
                        if (btnPaste != null && tvPaste != null)
                        {
                            ...
                            // Process
                            {
                                if (canPaste)
                                {
                                    ...
                                    tvPaste.text = txtPaste.get();
                                }
                                else
                                {
                                    btnPaste.interactable = false;
                                    tvPaste.text = txtCannotPaste.get();
                                }
                            }
                        }
                        else
