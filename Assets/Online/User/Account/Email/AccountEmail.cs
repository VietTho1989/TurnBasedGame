...
public class AccountEmail : Account
{
    ...
    public override AccountMessage makeAccountMessage()
    {
        AccountEmailMessage accountEmailMessage = new AccountEmailMessage();
        {
            ...
            accountEmailMessage.customName = this.customName.v;
            accountEmailMessage.isRegister = isRegister;
            Debug.LogError("makeAccountMessage: " + this.email.v + ", " + this.password.v + ", " + this.customName.v + ", " + isRegister);
        }
    ...
    {
        return string.IsNullOrEmpty(this.customName.v) ? this.email.v : this.customName.v;
    }
