                    ...
                    if (chatMessage != null)
                    {
                        // Find human
                        {
                            ...
                            if (human != null)
                            {
                                ...
                                {
                                    if (human.findDataInParent<ChatRoom>() == friendStateChangeContent.findDataInParent<ChatRoom>())
                                    {
                                        if (human.playerId.v == friendStateChangeContent.userId.v)
                                        {
                                            isCorrect = true;
                                        }
                                    }
                            ...
                            if (human == null)
                            {
                                human = ChatRoom.findHuman(friendStateChangeContent, friendStateChangeContent.userId.v);
                                if (human != null)
                                {
