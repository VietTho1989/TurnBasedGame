...
public class LoginUI : UIBehavior<LoginUI.UIData>
{
	...
	public Transform loginStateUIContainer;

	public RequestChangeEnumUI requestEnumPrefab;
	public Transform accountTypeContainer;

	public AccountUI accountUIPrefab;
	public Transform accountUIContainer;
	...
	public override void onAddCallBack<T> (T data)
	{
		...
		// Child
		{
					...
					// UI
					{
						...
						if (wrapProperty != null) {
							...
							case UIData.Property.accountType:
								UIUtils.Instantiate (requestChange, requestEnumPrefab, accountTypeContainer);
								break;
							default:
			...
			if (data is AccountUI.UIData) {
				...
				// UI
				{
					UIUtils.Instantiate (accountUIData, accountUIPrefab, accountUIContainer);
				}
				dirty = true;
				return;
			}
			...
			if (data is LoginStateUI.UIData) {
				...
				// UI
				{
					UIUtils.Instantiate (loginStateUIData, loginStateUIPrefab, loginStateUIContainer);
				}
				dirty = true;
				return;
			}
