...
public class RoomUserBtnUnKickUI : UIBehavior<RoomUserBtnUnKickUI.UIData>
{
	...
	public static readonly TxtLanguage txtCancelUnKick = new TxtLanguage();
	public static readonly TxtLanguage txtUnKicking = new TxtLanguage ();
	public static readonly TxtLanguage txtCannotUnKick = new TxtLanguage ();
