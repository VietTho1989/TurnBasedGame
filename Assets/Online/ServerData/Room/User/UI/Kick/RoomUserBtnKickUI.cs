...
public class RoomUserBtnKickUI : UIBehavior<RoomUserBtnKickUI.UIData>
{
	...
	public static readonly TxtLanguage txtCancelKick = new TxtLanguage ();
	public static readonly TxtLanguage txtKicking = new TxtLanguage ();
	public static readonly TxtLanguage txtCannotKick = new TxtLanguage ();
