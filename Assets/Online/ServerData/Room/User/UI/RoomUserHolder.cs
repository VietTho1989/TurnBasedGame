...
public class RoomUserHolder : SriaHolderBehavior<RoomUserHolder.UIData>
{
    ...
    public void onClickBtnShow()
    {
        if (this.data != null)
        {
            ...
            {
                // find type
                RoomUserAdapter.UIData.Type type = RoomUserAdapter.UIData.Type.Lobby;
                {
                    RoomUserAdapter.UIData roomUserAdapterUIData = this.data.findDataInParent<RoomUserAdapter.UIData>();
                    if (roomUserAdapterUIData != null)
                    {
                        type = roomUserAdapterUIData.type.v;
                    }
                    else
                    {
                ...
                switch (type)
                {
                    case RoomUserAdapter.UIData.Type.Lobby:
                        {
                            ...
                            if (roomUIData != null)
                            {
                                ...
                                RoomUserInformUI.UIData roomUserInformUIData = roomUIData.roomUserInformUI.newOrOld<RoomUserInformUI.UIData>();
                                {
                                    ...
                                    roomUserInformUIData.type.v = RoomUserInformUI.UIData.Type.Lobby;
                                }
                        ...
                        break;
                    case RoomUserAdapter.UIData.Type.Play:
                        {
                            RoomUserListUI.UIData roomUserListUIData = this.data.findDataInParent<RoomUserListUI.UIData>();
                            if (roomUserListUIData != null)
                            {
                                RoomUserInformUI.UIData roomUserInformUIData = roomUserListUIData.userInformUIData.newOrOld<RoomUserInformUI.UIData>();
                                {
                                    roomUserInformUIData.roomUser.v = new ReferenceData<RoomUser>(roomUser);
                                    roomUserInformUIData.type.v = RoomUserInformUI.UIData.Type.Play;
                                }
                                roomUserListUIData.userInformUIData.v = roomUserInformUIData;
                            }
                            else
                            {
