...
namespace GameManager.Match
{
    public class BtnContestUI : UIHaveTransformDataBehavior<BtnContestUI.UIData>
    {
        ...
        public override void Awake()
        {
            ...
            // OnClick
            {
                UIUtils.SetButtonOnClick(btnContest, onClickBtnContest);
            }
        }
            ...
            bool isProcess = false;
            {
                if (e.isKey && e.type == EventType.KeyUp)
                {
                    switch (e.keyCode)
                    {
                        case KeyCode.C:
                            {
                                if (btnContest != null && btnContest.gameObject.activeInHierarchy && btnContest.interactable)
                                {
                                    this.onClickBtnContest();
                                    isProcess = true;
                                }
                                else
                                {
