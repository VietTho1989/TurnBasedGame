...
{
    public class BtnRoundUI : UIHaveTransformDataBehavior<BtnRoundUI.UIData>
    {
            ...
            public bool processEvent(Event e)
            {
                bool isProcess = false;
                {
                    ...
                    if (!isProcess)
                    {
                        ...
                        {
                            BtnRoundUI btnRoundUI = this.findCallBack<BtnRoundUI>();
                            if (btnRoundUI != null)
                            {
                                isProcess = btnRoundUI.useShortKey(e);
                            }
                            else
                            {
                                Debug.LogError("btnRoundUI null: " + this);
                            }
                        }
                    }
                }
        ...
        public override void Awake()
        {
            ...
            // OnClick
            {
                UIUtils.SetButtonOnClick(btnRound, onClickBtnRound);
            }
        }
            ...
            bool isProcess = false;
            {
                if (e.isKey && e.type == EventType.KeyUp)
                {
                    switch (e.keyCode)
                    {
                        case KeyCode.R:
                            {
                                if (btnRound != null && btnRound.gameObject.activeInHierarchy && btnRound.interactable)
                                {
                                    this.onClickBtnRound();
                                    isProcess = true;
                                }
                                else
                                {
