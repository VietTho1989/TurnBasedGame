...
{
	public class MakrukCustomMove : GameMove
	{
		...
		{
			return string.Format ("MakrukCustomMove: {0}, {1}, {2}, {3}", this.fromX.v, this.fromY.v, this.destX.v, this.destY.v);
		}
