            ...
            if (gameMove != null)
            {
                ...
                bool needUpdate = true;
                {
                    switch (gameMove.getType())
                    {
                        ...
                        case GameMove.Type.SeirawanCustomFen:
                            {
                                SeirawanCustomFen seirawanCustomFen = gameMove as SeirawanCustomFen;
                                // Update
                                {
                                    tempSeirawan = Core.unityMakePositionByFen(seirawanCustomFen.fen.v, tempSeirawan.chess960.v);
                                }
                            }
                            break;
                        default:
