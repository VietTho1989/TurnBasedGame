...
namespace HEX.NoneRule
{
	public class ChoosePieceAdapter : SRIA<ChoosePieceAdapter.UIData, ChoosePieceHolder.UIData>
	{
		...
		public class UIData : BaseParams
		{
			...
			[NonSerialized]
			public List<Common.Color> pieces = new List<Common.Color>();
		...
		public override void refresh ()
		{
			if (dirty) {
				if (this.Initialized) {
					dirty = false;
					if (this.data != null) {
						List<Common.Color> pieces = new List<Common.Color> ();
						// get
						{
							// find alreadySelectPiece
							Common.Color alreadySelectPiece = Common.Color.Empty;
							{
								...
								if (noneRuleInputUIData != null) {
									...
									if (hex != null) {
										...
										if (setPieceUIData != null) {
											alreadySelectPiece = (Common.Color)hex.getPiece (setPieceUIData.square.v);
										} else {
						...
						// Make list
						{
							...
							// Add or Remove
							{
								if (pieces.Count > min) {
									...
									List<Common.Color> addItems = pieces.GetRange (min, insertCount);
