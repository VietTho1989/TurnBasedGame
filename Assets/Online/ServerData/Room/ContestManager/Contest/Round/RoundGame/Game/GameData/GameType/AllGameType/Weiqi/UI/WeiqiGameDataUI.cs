...
namespace Weiqi
{
    public class WeiqiGameDataUI : UIHaveTransformDataBehavior<WeiqiGameDataUI.UIData>
    {
        ...
        public class UIData : GameDataBoardUI.UIData.Sub
        {
            ...
            public VP<InformationUI.UIData> information;
                ...
                if (this.data != null)
                {
                    ...
                    Weiqi weiqi = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    weiqi = (Weiqi)gameType;
                                }
                                else
                                {
                                    Debug.LogError("why not weiqi: " + this);
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.weiqi.v = new ReferenceData<Weiqi>(weiqi);
                            }
                            else
                            {
                        ...
                        // hand
                        {
                            if (this.data.information.v != null)
                            {
                                this.data.information.v.weiqi.v = new ReferenceData<Weiqi>(weiqi);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.weiqi.v = new ReferenceData<Weiqi>(weiqi);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
        ...
        public InformationUI informationPrefab;
        ...
        public override void onAddCallBack<T>(T data)
        {
            if (data is UIData)
            {
                ...
                // Child
                {
                    ...
                    uiData.information.allAddCallBack(this);
        ...
        public override void onRemoveCallBack<T>(T data, bool isHide)
        {
            if (data is UIData)
            {
                ...
                // Child
                {
                    ...
                    uiData.information.allRemoveCallBack(this);
            ...
            // Child
            {
                ...
                if (data is InformationUI.UIData)
                {
                    ...
                    // UI
                    {
                        informationUIData.removeCallBackAndDestroy(typeof(InformationUI));
                    }
                    return;
                }
                if (data is LastMoveUI.UIData)
            ...
            if (wrapProperty.p is UIData)
            {
                switch ((UIData.Property)wrapProperty.n)
                {
                    ...
                    case UIData.Property.board:
                        ...
                        break;
                    case UIData.Property.information:
                        {
                            ValueChangeUtils.replaceCallBack(this, syncs);
                            dirty = true;
                        }
