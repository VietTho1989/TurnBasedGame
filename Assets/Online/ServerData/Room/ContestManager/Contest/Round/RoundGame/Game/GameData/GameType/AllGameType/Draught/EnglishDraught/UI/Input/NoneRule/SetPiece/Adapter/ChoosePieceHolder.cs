...
namespace EnglishDraught.NoneRule
{
    public class ChoosePieceHolder : SriaHolderBehavior<ChoosePieceHolder.UIData>
    {
        ...
        public class UIData : BaseItemViewsHolder
        {
            ...
            public UIData() : base()
            {
                this.piece = new VP<byte>(this, (byte)Property.piece, 0);
            }
        ...
        public void onClickBtnChoose()
        {
            if (this.data != null)
            {
                ...
                if (clientInput != null)
                {
                    EnglishDraughtCustomSet englishDraughtCustomSet = new EnglishDraughtCustomSet();
                    {
                        // square
                        {
                            ...
                            {
                                englishDraughtCustomSet.square.v = setPieceUIData.square.v;
                            }
                            else
                            {
                        ...
                        englishDraughtCustomSet.piece.v = this.data.piece.v;
                    }
                    clientInput.makeSend(englishDraughtCustomSet);
                }
                else
                {
