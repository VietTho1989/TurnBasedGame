...
{
	public class DefaultRussianDraughtUI : UIBehavior<DefaultRussianDraughtUI.UIData>
	{
		...
		public class UIData : DefaultGameTypeUI
		{
			...
			public VP<EditData<DefaultRussianDraught>> editDefaultRussianDraught;
			...
			{
				editDefaultRussianDraught,
				miniGameDataUIData
			}

			public UIData() : base()
			{
				this.editDefaultRussianDraught = new VP<EditData<DefaultRussianDraught>>(this, (byte)Property.editDefaultRussianDraught, new EditData<DefaultRussianDraught>());
		...
		public override void refresh ()
		{
			if (dirty) {
				dirty = false;
				if (this.data != null) {
					EditData<DefaultRussianDraught> editDefaultRussianDraught = this.data.editDefaultRussianDraught.v;
									...
									// gameData
									{
										...
										// Update Property
										{
											// GameType
											{
												...
												gameData.gameType.v = russianDraught;
											}
										}
									}
								}
		...
		public override void onAddCallBack<T> (T data)
		{
			...
			// Child
			{
				// editDefaultRussianDraught
				{
					if (data is EditData<DefaultRussianDraught>) {
						EditData<DefaultRussianDraught> editDefaultRussianDraught = data as EditData<DefaultRussianDraught>;
						// Child
						{
							editDefaultRussianDraught.show.allAddCallBack (this);
							editDefaultRussianDraught.compare.allAddCallBack (this);
						}
						dirty = true;
						return;
					}
					// Child
					{
						if (data is DefaultRussianDraught) {
							...
							// Parent
							{
								DataUtils.addParentCallBack (defaultRussianDraught, this, ref this.server);
							}
							needReset = true;
		...
		public override void onRemoveCallBack<T> (T data, bool isHide)
		{
			if (data is UIData) {
				...
				// Child
				{
					uiData.editDefaultRussianDraught.allRemoveCallBack (this);
			...
			// Child
			{
				// editDefaultRussianDraught
				{
					if (data is EditData<DefaultRussianDraught>) {
						...
						// Child
						{
							editDefaultRussianDraught.show.allRemoveCallBack (this);
							editDefaultRussianDraught.compare.allRemoveCallBack (this);
						}
						return;
					}
					// Child
					{
						if (data is DefaultRussianDraught) {
							...
							// Parent
							{
								DataUtils.removeParentCallBack (defaultRussianDraught, this, ref this.server);
							}
							return;
						}
						// Parent
		...
		public override void onUpdateSync<T> (WrapProperty wrapProperty, List<Sync<T>> syncs)
		{
			...
			if (wrapProperty.p is UIData) {
				...
				case UIData.Property.editDefaultRussianDraught:
					{
			...
			// Child
			{
				// EditDefaultRussianDraught
				{
					if (wrapProperty.p is EditData<DefaultRussianDraught>) {
						switch ((EditData<DefaultRussianDraught>.Property)wrapProperty.n) {
						case EditData<DefaultRussianDraught>.Property.origin:
							dirty = true;
							break;
						case EditData<DefaultRussianDraught>.Property.show:
							{
								ValueChangeUtils.replaceCallBack (this, syncs);
								dirty = true;
							}
							break;
						case EditData<DefaultRussianDraught>.Property.compare:
							{
								ValueChangeUtils.replaceCallBack (this, syncs);
								dirty = true;
							}
							break;
						case EditData<DefaultRussianDraught>.Property.compareOtherType:
							dirty = true;
							break;
						case EditData<DefaultRussianDraught>.Property.canEdit:
							dirty = true;
							break;
						case EditData<DefaultRussianDraught>.Property.editType:
							dirty = true;
							break;
						default:
							Debug.LogError ("Don't process: " + wrapProperty + "; " + this);
