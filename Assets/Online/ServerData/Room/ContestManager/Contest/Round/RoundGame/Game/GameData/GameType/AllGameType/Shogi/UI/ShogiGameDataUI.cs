...
namespace Shogi
{
    public class ShogiGameDataUI : UIHaveTransformDataBehavior<ShogiGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    Shogi shogi = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    shogi = gameType as Shogi;
                                }
                                else
                                {
                                    Debug.LogError("why not shogi: " + this);
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.shogi.v = new ReferenceData<Shogi>(shogi);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.shogi.v = new ReferenceData<Shogi>(shogi);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
