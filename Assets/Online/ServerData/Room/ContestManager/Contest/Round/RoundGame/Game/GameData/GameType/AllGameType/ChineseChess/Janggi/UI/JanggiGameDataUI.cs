...
namespace Janggi
{
    public class JanggiGameDataUI : UIHaveTransformDataBehavior<JanggiGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    // set reference data
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.janggi.v = new ReferenceData<Janggi>(janggi);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.janggi.v = new ReferenceData<Janggi>(janggi);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
