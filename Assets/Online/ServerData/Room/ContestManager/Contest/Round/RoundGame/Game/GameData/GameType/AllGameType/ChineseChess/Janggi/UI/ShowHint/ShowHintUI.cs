	...
	public class ShowHintUI : UIBehavior<ShowHintUI.UIData>
	{
				...
				if (this.data != null) {
					bool canShowHint = false;
					{
						...
						if (janggiGameDataUIData != null) {
							if (!janggiGameDataUIData.isOnAnimation.v) {
								canShowHint = true;
							}
						} else {
							Debug.LogError ("janggiGameDataUIData null: " + this);
						}
					}
					if (canShowHint) {
						// Find HintMove
						...
						if (hintMove != null) {
							...
							case GameMove.Type.JanggiMove:
								{
									JanggiMove janggiMove = hintMove as JanggiMove;
									// Find
									JanggiMoveUI.UIData janggiMoveUIData = this.data.sub.newOrOld<JanggiMoveUI.UIData>();
									{
										...
										// isHint
										janggiMoveUIData.isHint.v = true;
									}
							...
							case GameMove.Type.JanggiCustomMove:
								{
									JanggiCustomMove janggiCustomMove = hintMove as JanggiCustomMove;
									// Find
									JanggiCustomMoveUI.UIData janggiCustomMoveUIData = this.data.sub.newOrOld<JanggiCustomMoveUI.UIData>();
									{
										...
										// isHint
										janggiCustomMoveUIData.isHint.v = true;
									}
							...
							case GameMove.Type.JanggiCustomSet:
								{
									JanggiCustomSet janggiCustomSet = hintMove as JanggiCustomSet;
									// Find
									JanggiCustomSetUI.UIData janggiCustomSetUIData = this.data.sub.newOrOld<JanggiCustomSetUI.UIData>();
									{
										...
										// isHint
										janggiCustomSetUIData.isHint.v = true;
									}
		...
		public override void onAddCallBack<T> (T data)
		{
			if (data is UIData) {
				...
				// Parent
				{
					DataUtils.addParentCallBack (uiData, this, ref this.janggiGameDataUIData);
			...
			if (data is LastMoveSub) {
				...
				// UI
				{
					...
					case GameMove.Type.JanggiMove:
						{
							JanggiMoveUI.UIData janggiMoveUIData = sub as JanggiMoveUI.UIData;
							UIUtils.Instantiate (janggiMoveUIData, janggiMovePrefab, this.transform);
						}
						break;
					case GameMove.Type.JanggiCustomMove:
						{
							JanggiCustomMoveUI.UIData janggiCustomMoveUIData = sub as JanggiCustomMoveUI.UIData;
							UIUtils.Instantiate (janggiCustomMoveUIData, janggiCustomMovePrefab, this.transform);
						}
						break;
					case GameMove.Type.JanggiCustomSet:
						{
							JanggiCustomSetUI.UIData janggiCustomSetUIData = sub as JanggiCustomSetUI.UIData;
		...
		public override void onRemoveCallBack<T> (T data, bool isHide)
		{
			if (data is UIData) {
				...
				// Parent
				{
					DataUtils.removeParentCallBack (uiData, this, ref this.janggiGameDataUIData);
