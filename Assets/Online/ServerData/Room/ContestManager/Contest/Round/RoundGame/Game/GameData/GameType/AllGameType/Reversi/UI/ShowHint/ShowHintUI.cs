            ...
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    bool canShowHint = false;
                    {
                        ...
                        {
                            if (!reversiGameDataUIData.isOnAnimation.v)
                            {
                                canShowHint = true;
                            }
                        }
                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                case GameMove.Type.ReversiMove:
                                    {
                                        ReversiMove reversiMove = hintMove as ReversiMove;
                                        // Find
                                        ReversiMoveUI.UIData reversiMoveUIData = this.data.sub.newOrOld<ReversiMoveUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            reversiMoveUIData.isHint.v = true;
                                        }
                                ...
                                case GameMove.Type.ReversiCustomSet:
                                    {
                                        ReversiCustomSet reversiCustomSet = hintMove as ReversiCustomSet;
                                        // Find
                                        ReversiCustomSetUI.UIData reversiCustomSetUIData = this.data.sub.newOrOld<ReversiCustomSetUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            reversiCustomSetUIData.isHint.v = true;
                                        }
                                ...
                                case GameMove.Type.ReversiCustomMove:
                                    {
                                        ReversiCustomMove reversiCustomMove = hintMove as ReversiCustomMove;
                                        // Find
                                        ReversiCustomMoveUI.UIData reversiCustomMoveUIData = this.data.sub.newOrOld<ReversiCustomMoveUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            reversiCustomMoveUIData.isHint.v = true;
                                        }
                ...
                if (data is LastMoveSub)
                {
                    LastMoveSub sub = data as LastMoveSub;
                    {
                        switch (sub.getType())
                        {
                            case GameMove.Type.ReversiMove:
                                {
                                    ReversiMoveUI.UIData reversiMoveUIData = sub as ReversiMoveUI.UIData;
                                    UIUtils.Instantiate(reversiMoveUIData, reversiMovePrefab, this.transform);
                                }
                                break;
                            case GameMove.Type.ReversiCustomSet:
                                {
                                    ReversiCustomSetUI.UIData reversiCustomSetUIData = sub as ReversiCustomSetUI.UIData;
                                    UIUtils.Instantiate(reversiCustomSetUIData, reversiCustomSetPrefab, this.transform);
                                }
                                break;
                            case GameMove.Type.ReversiCustomMove:
                                {
                                    ReversiCustomMoveUI.UIData reversiCustomMoveUIData = sub as ReversiCustomMoveUI.UIData;
