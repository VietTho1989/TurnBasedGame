...
namespace Weiqi
{
    public class InputUI : UIBehavior<InputUI.UIData>
    {
                    ...
                    if (data != null)
                    {
                        ...
                        WaitInputAction waitInputAction = null;
                        {
                            ...
                            Weiqi weiqi = null;
                            {
                                ...
                                if (inputUIData != null)
                                {
                                    weiqi = inputUIData.weiqi.v.data;
                                }
                                else
                                {
                            ...
                            if (weiqi != null)
                            {
                                Game game = weiqi.findDataInParent<Game>();
                                if (game != null)
                                {
                            ...
                            {
                                Debug.LogError("weiqi null: " + data);
                            }
                        }
                        // Process
        ...
        public override void refresh()
        {
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    ...
                    {
                        // use rule or not
                        if (GameData.IsUseRule(this.data.weiqi.v.data))
                        {
                            // Find
                            UseRuleInputUI.UIData useRuleInputUIData = this.data.sub.newOrOld<UseRuleInputUI.UIData>();
                            {
                                // weiqi
                                useRuleInputUIData.weiqi.v = new ReferenceData<Weiqi>(this.data.weiqi.v.data);
                            }
                        ...
                        else
                        {
                            ...
                            {
                                // weiqi
                                noneRuleInputUIData.weiqi.v = new ReferenceData<Weiqi>(this.data.weiqi.v.data);
                            }
        ...
        private GameDataCheckChangeRule<Weiqi> gameDataCheckChangeRule = new GameDataCheckChangeRule<Weiqi>();
                ...
                // weiqi
                {
                    if (data is Weiqi)
                    {
                        ...
                        // Check change
                        {
                            ...
                            gameDataCheckChangeRule.setData(weiqi);
                        }
                        dirty = true;
                        return;
                    }
