...
namespace Solitaire
{
    public class SolitaireGameDataUI : UIHaveTransformDataBehavior<SolitaireGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    Solitaire solitaire = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    solitaire = gameType as Solitaire;
                                }
                                else
                                {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.solitaire.v = new ReferenceData<Solitaire>(solitaire);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.solitaire.v = new ReferenceData<Solitaire>(solitaire);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
