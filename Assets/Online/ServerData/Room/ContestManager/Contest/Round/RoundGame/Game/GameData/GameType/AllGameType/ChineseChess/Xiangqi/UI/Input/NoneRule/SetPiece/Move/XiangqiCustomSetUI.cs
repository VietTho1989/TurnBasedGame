					...
					if (xiangqiCustomSet != null) {
						...
						if (imgHint != null) {
							if (this.data.isHint.v) {
								// sprite
								imgHint.sprite = XiangqiSpriteContainer.get ().getSprite ((int)xiangqiCustomSet.piece.v);
								// position
								{
								...
								imgHint.sprite = XiangqiSpriteContainer.get ().getSprite ((int)Common.Piece.None);
							}
						} else {
