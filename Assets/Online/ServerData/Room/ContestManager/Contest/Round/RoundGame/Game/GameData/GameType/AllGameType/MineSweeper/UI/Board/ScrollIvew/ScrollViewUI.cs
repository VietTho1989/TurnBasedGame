...
namespace MineSweeper
{
    public class ScrollViewUI : UIBehavior<ScrollViewUI.UIData>
    {
        ...
        public class UIData : Data
        {
            ...
            public VP<ScrollRequestChangeUI.UIData> x;
            ...
            public VP<ScrollRequestChangeUI.UIData> y;
            ...
            public UIData() : base()
            {
                // x
                {
                    this.x = new VP<ScrollRequestChangeUI.UIData>(this, (byte)Property.x, new ScrollRequestChangeUI.UIData());
                    // have limit
                    {
                ...
                // y
                {
                    this.y = new VP<ScrollRequestChangeUI.UIData>(this, (byte)Property.y, new ScrollRequestChangeUI.UIData());
                    // have limit
                    {
                        FloatLimit.Have have = new FloatLimit.Have();
                        {
                    ...
                    if (boardUIData != null)
                    {
                        ...
                        // limit
                        {
                            ...
                            if (mineSweeper != null)
                            {
                                // x
                                {
                                    ...
                                    {
                                        ScrollRequestChangeUI.UIData x = this.data.x.v;
                                        if (x != null)
                                        {
                                ...
                                // y
                                {
                                    ...
                                    {
                                        ScrollRequestChangeUI.UIData y = this.data.y.v;
                                        if (y != null)
                                        {
                        ...
                        // x
                        {
                            ...
                            if (x != null)
                            {
                                ...
                                {
                                    // show
                                    if (xRequestChange != null)
                                    {
                                        xRequestChange.gameObject.SetActive(true);
                                    }
                                    else
                                    {
                                ...
                                else
                                {
                                    ...
                                    if (xRequestChange != null)
                                    {
                                        xRequestChange.gameObject.SetActive(false);
                                    }
                                    else
                                    {
                                        Debug.LogError("xContainer null: " + this);
                        ...
                        // y
                        {
                            ...
                            if (y != null)
                            {
                                ...
                                {
                                    // show
                                    if (yRequestChange != null)
                                    {
                                        yRequestChange.gameObject.SetActive(true);
                                    }
                                    else
                                    {
                                ...
                                else
                                {
                                    ...
                                    if (yRequestChange != null)
                                    {
                                        yRequestChange.gameObject.SetActive(false);
                                    }
                                    else
                                    {
                                        Debug.LogError("yContainer null: " + this);
        ...
        public ScrollRequestChangeUI xRequestChange;
        public ScrollRequestChangeUI yRequestChange;
        ...
        public override void onAddCallBack<T>(T data)
        {
            ...
            {
                // x, y
                if (data is ScrollRequestChangeUI.UIData)
                {
                    ScrollRequestChangeUI.UIData requestChange = data as ScrollRequestChangeUI.UIData;
                    // UI
                    {
                        ...
                        if (wrapProperty != null)
                        {
                            switch ((UIData.Property)wrapProperty.n)
                            {
                                case UIData.Property.x:
                                    if (xRequestChange != null)
                                    {
                                        xRequestChange.setData(requestChange);
                                    }
                                    else
                                    {
                                ...
                                case UIData.Property.y:
                                    if (yRequestChange != null)
                                    {
                                        yRequestChange.setData(requestChange);
                                    }
                                    else
                                    {
                                        Debug.LogError("y null");
                                    }
                                    break;
                                default:
                        ...
                        if (wrapProperty != null)
                        {
                            switch ((UIData.Property)wrapProperty.n)
                            {
                                case UIData.Property.x:
                                    if (xRequestChange != null)
                                    {
                                        xRequestChange.setDataNull(requestChange);
                                    }
                                    else
                                    {
                                        Debug.LogError("x null");
                                ...
                                case UIData.Property.y:
                                    if (yRequestChange != null)
                                    {
                                        yRequestChange.setDataNull(requestChange);
                                    }
                                    else
                                    {
                                        Debug.LogError("y null");
