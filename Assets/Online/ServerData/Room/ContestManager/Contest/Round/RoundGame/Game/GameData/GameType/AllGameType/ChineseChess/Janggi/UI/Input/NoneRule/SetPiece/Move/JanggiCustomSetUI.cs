					...
					if (janggiCustomSet != null) {
						...
						if (imgHint != null) {
							if (this.data.isHint.v) {
								// sprite
								imgHint.sprite = JanggiSpriteContainer.get ().getSprite ((uint)janggiCustomSet.piece.v);
								// position
								{
								...
								imgHint.sprite = JanggiSpriteContainer.get ().getSprite ((uint)StoneHelper.Stones.Empty);
							}
						} else {
