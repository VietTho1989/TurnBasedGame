...
namespace Banqi
{
    public class BanqiGameDataUI : UIHaveTransformDataBehavior<BanqiGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    // set reference data
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.banqi.v = new ReferenceData<Banqi>(banqi);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.banqi.v = new ReferenceData<Banqi>(banqi);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
