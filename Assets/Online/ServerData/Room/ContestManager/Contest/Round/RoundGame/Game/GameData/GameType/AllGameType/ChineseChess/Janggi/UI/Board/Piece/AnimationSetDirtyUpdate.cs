	...
	public class AnimationSetDirtyUpdate : UpdateBehavior<BoardUI.UIData>
	{
							...
							case GameMove.Type.JanggiMove:
								{
									...
									foreach (PieceUI.UIData pieceUIData in this.data.pieces.vs) {
										if ((pieceUIData.x.v == janggiMoveAnimation.fromX.v && pieceUIData.y.v == janggiMoveAnimation.fromY.v) ||
										   (pieceUIData.x.v == janggiMoveAnimation.toX.v && pieceUIData.y.v == janggiMoveAnimation.toY.v)) {
		...
		public override void onUpdateSync<T> (WrapProperty wrapProperty, List<Sync<T>> syncs)
		{
			...
			if (wrapProperty.p is BoardUI.UIData) {
				...
				case BoardUI.UIData.Property.janggi:
					break;
