...
namespace Xiangqi
{
    public class XiangqiIdentity : DataIdentity
    {
        ...
        private void OnUcsqPiecesChanged(SyncListByte.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnWBitRanksChanged(SyncListUShort.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnWBitFilesChanged(SyncListUShort.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnUcRepHashChanged(SyncListUInt.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
