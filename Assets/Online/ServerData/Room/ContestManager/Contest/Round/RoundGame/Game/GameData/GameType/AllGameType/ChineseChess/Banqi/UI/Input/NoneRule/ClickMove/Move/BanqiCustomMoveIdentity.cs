...
{
	public class BanqiCustomMoveIdentity : DataIdentity
	{
		...
		private NetData<BanqiCustomMove> netData = new NetData<BanqiCustomMove>();
		...
		public override void onAddCallBack<T> (T data)
		{
			if (data is BanqiCustomMove) {
				BanqiCustomMove banqiCustomMove = data as BanqiCustomMove;
				// Set new parent
				this.addTransformToParent();
				// Set property
				{
					this.serialize (this.searchInfor, banqiCustomMove.makeSearchInforms ());
					this.fromX = banqiCustomMove.fromX.v;
					this.fromY = banqiCustomMove.fromY.v;
					this.destX = banqiCustomMove.destX.v;
					this.destY = banqiCustomMove.destY.v;
				}
				// Observer
				{
					...
					if (observer != null) {
						...
						observer.setCheckChangeData (banqiCustomMove);
					} else {
