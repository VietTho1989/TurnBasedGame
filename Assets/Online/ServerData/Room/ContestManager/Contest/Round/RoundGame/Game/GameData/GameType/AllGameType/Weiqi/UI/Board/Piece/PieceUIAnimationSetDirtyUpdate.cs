...
namespace Weiqi
{
	public class PieceUIAnimationSetDirtyUpdate : UpdateBehavior<BoardUI.UIData>
	{
							...
							/*case GameMove.Type.WeiqiMove:
								{
									...
									foreach (PieceUI.UIData pieceUIData in this.data.pieces.vs) {
										if (weiqiMoveAnimation.coord.v == pieceUIData.coord.v ||
											weiqiMoveAnimation.captureCoords.vs.Contains (pieceUIData.coord.v)) {
