...
namespace Sudoku
{
    public class SudokuInformationUI : UIHaveTransformDataBehavior<SudokuInformationUI.UIData>
    {
        ...
        {
            txtMessage.add(Language.Type.vi, "https://vi.wikipedia.org/wiki/Sudoku");
        }
                ...
                if (this.data != null)
                {
                    ...
                    if (sudoku != null)
                    {
                        ...
                        // txt
                        {
                            if (lbTitle != null)
                            {
                                lbTitle.text = GameType.GetStrGameType(GameType.Type.Sudoku);
                            }
                            else
                            {
                                Debug.LogError("lbTitle null");
