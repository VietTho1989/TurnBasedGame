                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            if (noneRuleInputUIData != null)
                            {
                                ...
                                if (khet != null)
                                {
                                    currentFen = Core.unityPositionToFen(khet, Core.CanCorrect);
                                }
                                else
                                {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            KhetCustomFen khetCustomFen = new KhetCustomFen();
                            {
                                khetCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(khetCustomFen);
                        }
                        else
                        {
