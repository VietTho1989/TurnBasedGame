...
namespace Xiangqi
{
    public class XiangqiGameDataUI : UIHaveTransformDataBehavior<XiangqiGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    // set reference data
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.xiangqi.v = new ReferenceData<Xiangqi>(xiangqi);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.xiangqi.v = new ReferenceData<Xiangqi>(xiangqi);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
        ...
        public override void onRemoveCallBack<T>(T data, bool isHide)
        {
            if (data is UIData)
            {
                ...
                // Child
                {
                    uiData.gameData.v.removeCallBack(this);
