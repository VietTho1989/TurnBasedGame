...
namespace Shatranj
{
	public class ShatranjStateInfo : Data
	{
		...
		public static byte[] convertToBytes(ShatranjStateInfo st)
		{
			byte[] byteArray;
		...
		public static int parse(ShatranjStateInfo st, byte[] byteArray, int start)
		{
