            ...
            if (dirty)
            {
                if (this.data != null)
                {
                    ...
                    if (russianDraught != null)
                    {
                        ...
                        {
                            // pieces
                            bool blindFold = GameData.IsBlindFold(russianDraught);
                            {
                                // get old
                ...
                // russianDraught
                {
                    if (data is RussianDraught)
                    {
                        ...
                        // checkChange
                        {
                            ...
                            gameDataCheckChangeBlindFold.setData(russianDraught);
                        }
                        dirty = true;
                        return;
                    }
                    // checkChange
                    if (data is GameDataCheckChangeBlindFold<RussianDraught>)
                    {
                        dirty = true;
                        return;
                    }
        ...
        public override void onUpdateSync<T>(WrapProperty wrapProperty, List<Sync<T>> syncs)
        {
            ...
            // Child
            {
                // russianDraught
                {
                    ...
                    // checkChange
                    if (wrapProperty.p is GameDataCheckChangeBlindFold<RussianDraught>)
                    {
                        dirty = true;
                        return;
                    }
