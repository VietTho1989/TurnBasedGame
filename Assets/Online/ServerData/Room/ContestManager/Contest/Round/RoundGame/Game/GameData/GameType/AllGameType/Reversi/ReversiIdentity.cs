...
namespace Reversi
{
	public class ReversiIdentity : DataIdentity
	{
		...
		private void OnMovesChanged(SyncListSByte.Operation op, int index, MySByte item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnChangesChanged(SyncListUInt64.Operation op, int index, MyUInt64 item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnOldSidesChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
