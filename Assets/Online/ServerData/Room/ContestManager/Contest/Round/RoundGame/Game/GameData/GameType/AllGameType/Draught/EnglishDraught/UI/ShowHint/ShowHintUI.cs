                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                ...
                                case GameMove.Type.EnglishDraughtCustomFen:
                                    {
                                        EnglishDraughtCustomFen englishDraughtCustomFen = hintMove as EnglishDraughtCustomFen;
                                        // Find
                                        EnglishDraughtCustomFenUI.UIData englishDraughtCustomFenUIData = this.data.sub.newOrOld<EnglishDraughtCustomFenUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            englishDraughtCustomFenUIData.isHint.v = true;
                                        }
                ...
                if (data is LastMoveSub)
                {
                    LastMoveSub sub = data as LastMoveSub;
                    {
                        switch (sub.getType())
                        {
                            ...
                            case GameMove.Type.EnglishDraughtCustomFen:
                                {
                                    EnglishDraughtCustomFenUI.UIData englishDraughtCustomFenUIData = sub as EnglishDraughtCustomFenUI.UIData;
