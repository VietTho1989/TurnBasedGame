...
namespace Seirawan
{
    public class PieceUI : UIBehavior<PieceUI.UIData>
    {
        ...
        {
            return Setting.get().defaultChosenGame.v.getGame() == GameType.Type.Seirawan ? 32 : 0;
        }
                            ...
                            // Image
                            {
                                if (image != null)
                                {
                                    if (!this.data.blindFold.v)
                                    {
                                        ...
                                        // sprite
                                        {
                                            Sprite sprite = SeirawanSpriteContainer.get().getSprite(this.data.piece.v);
                                            {
                                                        ...
                                                        case GameMove.Type.SeirawanMove:
                                                            {
                                                                ...
                                                                switch (move.type)
                                                                {
                                                                    case Common.MoveType.NORMAL:
                                                                        sprite = SeirawanSpriteContainer.get().getSprite(this.data.piece.v);
                                                                        break;
                                                                    ...
                                                                    case Common.MoveType.PROMOTION:
                                                                        {
                                                                            if ((int)move.ori == this.data.position.v)
                                                                            {
                                                                                ...
                                                                                else
                                                                                {
                                                                                    ...
                                                                                    sprite = SeirawanSpriteContainer.get().getSprite(showPromotion ? Common.make_piece(Common.color_of(this.data.piece.v), move.promotion) : this.data.piece.v);
                                                                                }
                                                                            }
                                                                            else
                                                                            {
