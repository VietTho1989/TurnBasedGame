...
{
    public class NineMenMorrisGameDataUI : UIHaveTransformDataBehavior<NineMenMorrisGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    NineMenMorris nineMenMorris = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    nineMenMorris = gameType as NineMenMorris;
                                }
                                else
                                {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.nineMenMorris.v = new ReferenceData<NineMenMorris>(nineMenMorris);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.nineMemMorris.v = new ReferenceData<NineMenMorris>(nineMenMorris);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
