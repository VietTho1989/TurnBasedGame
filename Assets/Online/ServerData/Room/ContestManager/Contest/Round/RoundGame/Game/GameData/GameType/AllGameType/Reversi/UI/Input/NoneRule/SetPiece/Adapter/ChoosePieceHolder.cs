            ...
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    // imgPiece
                    {
                        if (imgPiece != null)
                        {
                            imgPiece.sprite = ReversiSpriteContainer.get().getSprite(this.data.piece.v);
                        }
                        else
                        {
                ...
                if (clientInput != null)
                {
                    ReversiCustomSet reversiCustomSet = new ReversiCustomSet();
                    {
                        // square
                        {
                            ...
                            {
                                reversiCustomSet.square.v = setPieceUIData.square.v;
                            }
                            else
                            {
                        ...
                        reversiCustomSet.piece.v = this.data.piece.v;
                    }
                    clientInput.makeSend(reversiCustomSet);
                }
                else
                {
