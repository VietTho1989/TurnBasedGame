                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                ...
                                case GameMove.Type.ChessCustomFen:
                                    {
                                        ChessCustomFen chessCustomFen = hintMove as ChessCustomFen;
                                        // Find
                                        ChessCustomFenUI.UIData chessCustomFenUIData = this.data.sub.newOrOld<ChessCustomFenUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            chessCustomFenUIData.isHint.v = true;
                                        }
                ...
                if (data is LastMoveSub)
                {
                    ...
                    // UI
                    {
                        switch (sub.getType())
                        {
                            ...
                            case GameMove.Type.ChessCustomFen:
                                {
                                    ChessCustomFenUI.UIData chessCustomFenUIData = sub as ChessCustomFenUI.UIData;
