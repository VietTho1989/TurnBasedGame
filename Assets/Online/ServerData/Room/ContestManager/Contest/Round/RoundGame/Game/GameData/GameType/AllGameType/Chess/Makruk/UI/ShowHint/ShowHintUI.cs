                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                ...
                                case GameMove.Type.MakrukCustomFen:
                                    {
                                        MakrukCustomFen makrukCustomFen = hintMove as MakrukCustomFen;
                                        // Find
                                        MakrukCustomFenUI.UIData makrukCustomFenUIData = this.data.sub.newOrOld<MakrukCustomFenUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            makrukCustomFenUIData.isHint.v = true;
                                        }
                ...
                if (data is LastMoveSub)
                {
                    LastMoveSub sub = data as LastMoveSub;
                    {
                        switch (sub.getType())
                        {
                            ...
                            case GameMove.Type.MakrukCustomFen:
                                {
                                    MakrukCustomFenUI.UIData makrukCustomFenUIData = sub as MakrukCustomFenUI.UIData;
