                    ...
                    if (x >= 0 && x <= 6 && y >= 0 && y <= 6)
                    {
                        ...
                        else
                        {
                            ...
                            if (clientInput != null)
                            {
                                ...
                                {
                                    nineMenMorrisCustomMove.fromX.v = this.data.x.v;
                                    nineMenMorrisCustomMove.fromY.v = this.data.y.v;
                                    nineMenMorrisCustomMove.destX.v = x;
                                    nineMenMorrisCustomMove.destY.v = y;
                                }
                                clientInput.makeSend(nineMenMorrisCustomMove);
                            }
                            else
                            {
