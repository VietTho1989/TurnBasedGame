...
{
    public class FairyChessGameDataUI : UIHaveTransformDataBehavior<FairyChessGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    FairyChess fairyChess = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    fairyChess = gameType as FairyChess;
                                }
                                else
                                {
                                    Debug.LogError("why not fairyChess");
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.fairyChess.v = new ReferenceData<FairyChess>(fairyChess);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.fairyChess.v = new ReferenceData<FairyChess>(fairyChess);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
