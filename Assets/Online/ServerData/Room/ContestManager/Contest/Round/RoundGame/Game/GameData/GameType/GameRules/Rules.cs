                                            ...
                                            case AbstractRuleList.k:
                                                {
                                                    ...
                                                    // check other king
                                                    {
                                                        ...
                                                        {
                                                            int distance = 0;
                                                            int maxDistance = Mathf.Max(board.side.GetLength(0), board.side.GetLength(1));
                                                            do
                                                            {
                                                                distance++;
                                                                ...
                                                                if (board.board[kingX, kingY] != 0)
                                                                {
                                                                    if (board.board[kingX, kingY] == ruleSet.otherKing)
                                                                    {
                                                                        // Debug.LogError("find other king");
                                                                        Coord coord = new Coord();
                                                                        {
