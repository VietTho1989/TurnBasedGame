...
namespace Makruk
{
	public class MakrukStateInfoIdentity : DataIdentity
	{
		...
		private NetData<MakrukStateInfo> netData = new NetData<MakrukStateInfo>();
		...
		{
			if (data is MakrukStateInfo) {
				MakrukStateInfo stateInfo = data as MakrukStateInfo;
				// Set new parent
