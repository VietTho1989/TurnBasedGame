    ...
    public class ChoosePieceHolder : SriaHolderBehavior<ChoosePieceHolder.UIData>
    {
        ...
        public void onClickBtnChoose()
        {
            if (this.data != null)
            {
                ...
                if (clientInput != null)
                {
                    SeirawanCustomSet seirawanCustomSet = new SeirawanCustomSet();
                    {
                        // x, y
                        {
                            ...
                            {
                                seirawanCustomSet.x.v = setPieceUIData.x.v;
                                seirawanCustomSet.y.v = setPieceUIData.y.v;
                            }
                            else
                            {
                        ...
                        seirawanCustomSet.piece.v = this.data.piece.v;
                    }
                    clientInput.makeSend(seirawanCustomSet);
                }
                else
                {
