...
namespace FairyChess
{
    public class InputUI : UIBehavior<InputUI.UIData>
    {
                ...
                ClientInput clientInput = null;
                {
                    if (data != null)
                    {
                        ...
                        WaitInputAction waitInputAction = null;
                        {
                            ...
                            {
                                Debug.LogError("fairyChess null: " + data);
                            }
                        }
                        // Process
            ...
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    ...
                    if (fairyChess != null)
                    {
                        ...
                        {
                            // use rule or not
                            if (GameData.IsUseRule(this.data.fairyChess.v.data))
                            {
                                // Find
                                UseRuleInputUI.UIData useRuleInputUIData = this.data.sub.newOrOld<UseRuleInputUI.UIData>();
                                {
                                    // fairyChess
                                    useRuleInputUIData.fairyChess.v = new ReferenceData<FairyChess>(this.data.fairyChess.v.data);
                                }
                            ...
                            else
                            {
                                ...
                                {
                                    // fairyChess
                                    noneRuleInputUIData.fairyChess.v = new ReferenceData<FairyChess>(this.data.fairyChess.v.data);
                                }
        ...
        private GameDataCheckChangeRule<FairyChess> gameDataCheckChangeRule = new GameDataCheckChangeRule<FairyChess>();
                ...
                // fairyChess
                {
                    if (data is FairyChess)
                    {
                        ...
                        // Check change
                        {
                            ...
                            gameDataCheckChangeRule.setData(fairyChess);
                        }
                        dirty = true;
                        return;
                    }
                    // CheckChange
                    if (data is GameDataCheckChangeRule<FairyChess>)
                    {
                        dirty = true;
                        return;
                    }
        ...
        public override void onUpdateSync<T>(WrapProperty wrapProperty, List<Sync<T>> syncs)
        {
            ...
            // Child
            {
                // fairyChess
                {
                    ...
                    // Check change
                    {
                        if (wrapProperty.p is GameDataCheckChangeRule<FairyChess>)
                        {
                            dirty = true;
                            return;
                        }
