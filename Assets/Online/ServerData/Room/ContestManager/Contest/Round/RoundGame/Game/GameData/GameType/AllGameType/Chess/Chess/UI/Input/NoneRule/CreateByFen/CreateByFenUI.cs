                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            if (noneRuleInputUIData != null)
                            {
                                ...
                                if (chess != null)
                                {
                                    currentFen = Core.unityPositionToFen(chess, Core.CanCorrect);
                                }
                                else
                                {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            ChessCustomFen chessCustomFen = new ChessCustomFen();
                            {
                                chessCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(chessCustomFen);
                        }
                        else
                        {
