				...
				if (this.data != null) {
					...
					if (reversiMove != null) {
						...
						if (lineRenderer != null) {
							...
							{
								points [0] = new Vector2 (x + 0.5f - 8 / 2.0f + 0.5f, y + 0.5f - 8 / 2.0f + 0.5f);
								points [1] = new Vector2 (x - 0.5f - 8 / 2.0f + 0.5f, y + 0.5f - 8 / 2.0f + 0.5f);
								points [2] = new Vector2 (x - 0.5f - 8 / 2.0f + 0.5f, y - 0.5f - 8 / 2.0f + 0.5f);
								points [3] = new Vector2 (x + 0.5f - 8 / 2.0f + 0.5f, y - 0.5f - 8 / 2.0f + 0.5f);
								points [4] = new Vector2 (x + 0.5f - 8 / 2.0f + 0.5f, y + 0.5f - 8 / 2.0f + 0.5f);
							}
