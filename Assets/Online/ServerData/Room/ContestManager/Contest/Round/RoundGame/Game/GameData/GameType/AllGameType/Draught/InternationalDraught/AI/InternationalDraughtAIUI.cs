            ...
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    ...
                    // UI
                    {
                        ...
                        // bMove
                        {
                            if (this.data.bMove.v != null)
                            {
                                if (lbBMove != null)
                                {
                                    lbBMove.gameObject.SetActive(true);
                                    UIRectTransform.SetPosY(lbBMove.rectTransform, deltaY);
                                }
                                else
                                {
                                    Debug.LogError("lbBMove null");
                                }
                                UIRectTransform.SetPosY(this.data.bMove.v, deltaY + (UIConstants.ItemHeight - UIConstants.RequestBoolDim) / 2.0f);
                            ...
                            else
                            {
                                if (lbBMove != null)
                                {
                                    lbBMove.gameObject.SetActive(false);
                                }
                                else
                                {
                                    Debug.LogError("lbBMove null");
                        ...
                        // book
                        {
                            if (this.data.book.v != null)
                            {
                                if (lbBook != null)
                                {
                                    lbBook.gameObject.SetActive(true);
                                    UIRectTransform.SetPosY(lbBook.rectTransform, deltaY);
                                }
                                else
                                {
                                    Debug.LogError("lbBook null");
                                }
                                UIRectTransform.SetPosY(this.data.book.v, deltaY + (UIConstants.ItemHeight - UIConstants.RequestBoolDim) / 2.0f);
                                deltaY += UIConstants.ItemHeight;
                            }
                            else
                            {
                                if (lbBook != null)
                                {
                                    lbBook.gameObject.SetActive(false);
                                }
                                else
                                {
                                    Debug.LogError("lbBook null");
                        ...
                        // input
                        {
                            if (this.data.input.v != null)
                            {
                                if (lbInput != null)
                                {
                                    lbInput.gameObject.SetActive(true);
                                    UIRectTransform.SetPosY(lbInput.rectTransform, deltaY);
                                }
                                else
                                {
                                    Debug.LogError("lbInput null");
                                }
                                UIRectTransform.SetPosY(this.data.input.v, deltaY + (UIConstants.ItemHeight - UIConstants.RequestBoolDim) / 2.0f);
                                deltaY += UIConstants.ItemHeight;
                            }
                            else
                            {
                                if (lbInput != null)
                                {
                                    lbInput.gameObject.SetActive(false);
                                }
                                else
                                {
                                    Debug.LogError("lbInput null");
                        ...
                        // useEndGameDatabase
                        {
                            if (this.data.useEndGameDatabase.v != null)
                            {
                                if (lbUseEndGameDatabase != null)
                                {
                                    lbUseEndGameDatabase.gameObject.SetActive(true);
                                    UIRectTransform.SetPosY(lbUseEndGameDatabase.rectTransform, deltaY);
                                }
                                else
                                {
                                    Debug.LogError("lbUseEndGameDatabase null");
                                }
                                UIRectTransform.SetPosY(this.data.useEndGameDatabase.v, deltaY + (UIConstants.ItemHeight - UIConstants.RequestBoolDim) / 2.0f);
                                deltaY += UIConstants.ItemHeight;
                            }
                            else
                            {
                                if (lbUseEndGameDatabase != null)
                                {
                                    lbUseEndGameDatabase.gameObject.SetActive(false);
                                }
                                else
                                {
                                    Debug.LogError("lbUseEndGameDatabase null");
