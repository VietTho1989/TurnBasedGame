...
{
    public class EnglishDraughtGameDataUI : UIHaveTransformDataBehavior<EnglishDraughtGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    EnglishDraught englishDraught = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    englishDraught = (EnglishDraught)gameType;
                                }
                                else
                                {
                                    Debug.LogError("why not englishDraught: " + this);
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.englishDraught.v = new ReferenceData<EnglishDraught>(englishDraught);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.englishDraught.v = new ReferenceData<EnglishDraught>(englishDraught);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
