...
namespace Gomoku
{
	public class GomokuIdentity : DataIdentity
	{
		...
		private void OnGsChanged(SyncListByte.Operation op, int index, MyByte item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnLastMoveChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnWinCoordChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
