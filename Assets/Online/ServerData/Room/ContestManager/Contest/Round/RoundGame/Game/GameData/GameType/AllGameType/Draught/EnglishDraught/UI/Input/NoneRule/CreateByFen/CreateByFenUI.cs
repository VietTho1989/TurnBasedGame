                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            if (noneRuleInputUIData != null)
                            {
                                ...
                                {
                                    currentFen = Core.unityGetFen(englishDraught, Core.CanCorrect);
                                }
                                else
                                {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            EnglishDraughtCustomFen englishDraughtCustomFen = new EnglishDraughtCustomFen();
                            {
                                englishDraughtCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(englishDraughtCustomFen);
                        }
                        else
                        {
