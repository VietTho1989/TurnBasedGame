                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                ...
                                case GameMove.Type.InternationalDraughtCustomFen:
                                    {
                                        InternationalDraughtCustomFen internationalDraughtCustomFen = hintMove as InternationalDraughtCustomFen;
                                        // Find
                                        InternationalDraughtCustomFenUI.UIData internationalDraughtCustomFenUIData = this.data.sub.newOrOld<InternationalDraughtCustomFenUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            internationalDraughtCustomFenUIData.isHint.v = true;
                                        }
                ...
                if (data is LastMoveSub)
                {
                    LastMoveSub sub = data as LastMoveSub;
                    {
                        switch (sub.getType())
                        {
                            ...
                            case GameMove.Type.InternationalDraughtCustomFen:
                                {
                                    InternationalDraughtCustomFenUI.UIData internationalDraughtCustomFenUIData = sub as InternationalDraughtCustomFenUI.UIData;
