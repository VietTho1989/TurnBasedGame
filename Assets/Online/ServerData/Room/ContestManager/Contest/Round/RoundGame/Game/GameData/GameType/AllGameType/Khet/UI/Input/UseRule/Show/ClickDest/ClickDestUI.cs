...
namespace Khet.UseRule
{
    public class ClickDestUI : UIBehavior<ClickDestUI.UIData>, IPointerDownHandler
    {
        ...
        public class UIData : ShowUI.UIData.Sub
        {
            ...
            public VP<bool> canRotateAdd;

            public VP<bool> canRotateSub;

            public VP<ClickDestBtnRotateUI.UIData> btnRotate;
            ...
            public UIData() : base()
            {
                ...
                this.canRotateAdd = new VP<bool>(this, (byte)Property.canRotateAdd, false);
                this.canRotateSub = new VP<bool>(this, (byte)Property.canRotateSub, false);
                this.btnRotate = new VP<ClickDestBtnRotateUI.UIData>(this, (byte)Property.btnRotate, new ClickDestBtnRotateUI.UIData());
            }
        ...
        static ClickDestUI()
        {
            // rect
            {
                // btnRotateRect
                {
                    // anchoredPosition: (0.0, 0.0); anchorMin: (0.0, 0.0); anchorMax: (1.0, 0.0); pivot: (0.5, 1.0);
                    // offsetMin: (0.0, -30.0); offsetMax: (0.0, 0.0); sizeDelta: (0.0, 30.0);
                    btnRotateRect.anchoredPosition = new Vector3(0.0f, 0.0f, 0.0f);
                    btnRotateRect.anchorMin = new Vector2(0.0f, 0.0f);
                    btnRotateRect.anchorMax = new Vector2(1.0f, 0.0f);
                    btnRotateRect.pivot = new Vector2(0.5f, 1.0f);
                    btnRotateRect.offsetMin = new Vector2(0.0f, -30.0f);
                    btnRotateRect.offsetMax = new Vector2(0.0f, 0.0f);
                    btnRotateRect.sizeDelta = new Vector2(0.0f, 30.0f);
                }
            }
        }
            ...
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    ...
                    // btnRotate
                    {
                        ...
                        this.data.canRotateAdd.v = canRotateAdd;
                        this.data.canRotateSub.v = canRotateSub;
                    }
                }
                else
                {
        ...
        public ClickDestBtnRotateUI btnRotatePrefab;
        private static readonly UIRectTransform btnRotateRect = new UIRectTransform();
        ...
        public override void onAddCallBack<T>(T data)
        {
            if (data is UIData)
            {
                ...
                // Child
                {
                    ...
                    uiData.btnRotate.allAddCallBack(this);
                }
                dirty = true;
                return;
            }
            ...
            // Child
            {
                ...
                if(data is ClickDestBtnRotateUI.UIData)
                {
                    ClickDestBtnRotateUI.UIData btnRotateUIData = data as ClickDestBtnRotateUI.UIData;
                    // UI
                    {
                        // find container
                        Transform btnRotateContainer = null;
                        {
                            GameDataBoardUI.UIData gameDataBoardUIData = btnRotateUIData.findDataInParent<GameDataBoardUI.UIData>();
                            if (gameDataBoardUIData != null)
                            {
                                GameDataBoardUI gameDataBoardUI = gameDataBoardUIData.findCallBack<GameDataBoardUI>();
                                if (gameDataBoardUI != null)
                                {
                                    btnRotateContainer = gameDataBoardUI.transform;
                                }
                                else
                                {
                        ...
                        // set
                        UIUtils.Instantiate(btnRotateUIData, btnRotatePrefab, btnRotateContainer, btnRotateRect);
                        UIRectTransform.SetSiblingIndex(btnRotateUIData, 0);
                    }
                    dirty = true;
                    return;
                }
        ...
        public override void onRemoveCallBack<T>(T data, bool isHide)
        {
            if (data is UIData)
            {
                ...
                // Child
                {
                    ...
                    uiData.btnRotate.allRemoveCallBack(this);
                }
            ...
            // Child
            {
                ...
                if (data is ClickDestBtnRotateUI.UIData)
                {
                    ...
                    // UI
                    {
                        btnRotateUIData.removeCallBackAndDestroy(typeof(ClickDestBtnRotateUI));
                    }
                    return;
                }
            }
        ...
        public override void onUpdateSync<T>(WrapProperty wrapProperty, List<Sync<T>> syncs)
        {
            ...
            if (wrapProperty.p is UIData)
            {
                switch ((UIData.Property)wrapProperty.n)
                {
                    ...
                    case UIData.Property.keyY:
                        dirty = true;
                        break;
                    case UIData.Property.btnRotate:
                        {
                            ValueChangeUtils.replaceCallBack(this, syncs);
                            dirty = true;
                        }
            ...
            // Child
            {
                ...
                if(wrapProperty.p is ClickDestBtnRotateUI.UIData)
                {
                    return;
                }
            }
