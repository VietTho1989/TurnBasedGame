						...
						if (gameData != null) {
							...
							if (gameType != null) {
								if (gameType is CoTuongUp) {
									coTuongUp = (CoTuongUp)gameType;
								} else {
									Debug.LogError ("why not coTuongUp: " + this);
								}
							} else {
					...
					// process
					{
						// board
						{
							if (this.data.board.v != null) {
								this.data.board.v.coTuongUp.v = new ReferenceData<CoTuongUp> (coTuongUp);
							} else {
						...
						// input
						{
							if (this.data.inputUI.v != null) {
								this.data.inputUI.v.coTuongUp.v = new ReferenceData<CoTuongUp> (coTuongUp);
							} else {
								Debug.LogError ("inputUI null: " + this);
							}
						}
