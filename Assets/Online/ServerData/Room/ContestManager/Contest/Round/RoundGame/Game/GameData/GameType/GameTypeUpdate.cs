            ...
            // Update
            {
                ...
                switch (gameType.getType())
                {
                    case GameType.Type.Rubiks:
                        {
                            Rubiks.Rubiks rubiks = gameType as Rubiks.Rubiks;
                            UpdateUtils.makeUpdate<Rubiks.RubiksUpdate, Rubiks.Rubiks>(rubiks, this.transform);
                        }
                        break;
            ...
            // Update
            {
                ...
                switch (gameType.getType())
                {
                    case GameType.Type.Rubiks:
                        {
                            Rubiks.Rubiks rubiks = gameType as Rubiks.Rubiks;
                            rubiks.removeCallBackAndDestroy(typeof(Rubiks.RubiksUpdate));
                        }
                        break;
                    case GameType.Type.Weiqi:
                        {
