                ...
                if (this.data != null)
                {
                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            {
                                Shatranj shatranj = noneRuleInputUIData.shatranj.v.data;
                                if (shatranj != null)
                                {
                                    currentFen = Core.unityPositionToFen(shatranj, Core.CanCorrect);
                                }
                                else
                                {
                    ...
                    // txt
                    {
                        ...
                        if (edtFen != null)
                        {
                            ...
                            {
                                Debug.LogError("textComponenet null");
                            }
                        }
                        else
                        {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            ShatranjCustomFen shatranjCustomFen = new ShatranjCustomFen();
                            {
                                shatranjCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(shatranjCustomFen);
                        }
                        else
                        {
