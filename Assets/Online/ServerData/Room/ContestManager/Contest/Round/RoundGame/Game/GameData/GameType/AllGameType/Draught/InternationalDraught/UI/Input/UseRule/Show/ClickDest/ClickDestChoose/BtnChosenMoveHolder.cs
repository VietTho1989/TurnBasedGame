...
namespace InternationalDraught.UseRule
{
    public class BtnChosenMoveHolder : SriaHolderBehavior<BtnChosenMoveHolder.UIData>
    {
        ...
        public class UIData : BaseItemViewsHolder
        {
            ...
            {
                // Find
                InternationalDraughtMove internationalDraughtMove = null;
                {
                    if (ItemIndex >= 0 && ItemIndex < myParams.internationalDraughtMoves.Count)
                    {
                        internationalDraughtMove = myParams.internationalDraughtMoves[ItemIndex];
                    }
                    else
                    {
                ...
                // Update
                this.internationalDraughtMove.v = new ReferenceData<InternationalDraughtMove>(internationalDraughtMove);
            }
                    ...
                    if (internationalDraughtMove != null)
                    {
                        // imgPiece
                        {
                            if (imgPiece != null)
                            {
                                ...
                                // set
                                {
                                    imgPiece.sprite = InternationalDraughtSpriteContainer.get().getSprite(pieceSide);
                                }
                            }
                            else
                            {
