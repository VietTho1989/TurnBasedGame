...
namespace RussianDraught
{
	public class RussianDraughtIdentity : DataIdentity
	{
		...
		private void OnRepNumChanged(SyncListUInt64.Operation op, int index, MyUInt64 item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnP_listChanged(SyncListUInt.Operation op, int index, uint item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnIndicesChanged(SyncListUInt.Operation op, int index, uint item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnG_piecesChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnReversibleChanged(SyncListBool.Operation op, int index, bool item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnC_numChanged(SyncListUInt.Operation op, int index, uint item)
		{
			if (this.netData.clientData != null) {
