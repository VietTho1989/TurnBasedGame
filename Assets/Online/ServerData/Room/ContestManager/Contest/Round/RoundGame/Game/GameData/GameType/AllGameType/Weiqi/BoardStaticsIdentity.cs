...
namespace Weiqi
{
    public class BoardStaticsIdentity : DataIdentity
    {
        ...
        private void OnNei8Changed(SyncListInt.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnDneiChanged(SyncListInt.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnHChanged(SyncListUInt64.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnCoordChanged(SyncListByte.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
