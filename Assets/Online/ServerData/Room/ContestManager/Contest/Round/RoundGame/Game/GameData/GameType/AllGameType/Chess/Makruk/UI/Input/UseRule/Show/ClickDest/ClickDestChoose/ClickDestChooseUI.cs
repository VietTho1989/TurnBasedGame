                ...
                if (this.data != null)
                {
                    List<MakrukMove> makrukMoves = new List<MakrukMove>();
                    {
                        ...
                        if (showUIData != null && clickDestUIData != null)
                        {
                            ...
                            {
                                MakrukMove legalMove = showUIData.legalMoves.vs[i];
                                if (MakrukMove.IsClickCorrectPosition(legalMove.move.v, fromX, fromY, destX, destY))
                                {
                                    makrukMoves.Add(legalMove);
                                }
                            }
                        }
                    }
                    ...
                    // btnChoseMoves
                    if (makrukMoves.Count == 0)
                    {
                        Debug.LogError("why makrukMoves count = 0: " + this);
                    ...
                    else if (makrukMoves.Count == 1)
                    {
                        MakrukMove makrukMove = makrukMoves[0];
                        // Send by clientInput
                        {
                            ClientInput clientInput = InputUI.UIData.findClientInput(this.data);
                            if (clientInput != null)
                            {
                                clientInput.makeSend(makrukMove);
                            }
                            else
                            {
