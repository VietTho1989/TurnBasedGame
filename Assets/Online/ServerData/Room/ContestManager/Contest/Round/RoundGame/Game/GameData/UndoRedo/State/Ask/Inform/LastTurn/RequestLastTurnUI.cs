...
namespace UndoRedo
{
    public class RequestLastTurnUI : UIHaveTransformDataBehavior<RequestLastTurnUI.UIData>
    {
            ...
            public bool processEvent(Event e)
            {
                bool isProcess = false;
                {
                    ...
                    if (!isProcess)
                    {
                        ...
                        {
                            RequestLastTurnUI requestLastTurnUI = this.findCallBack<RequestLastTurnUI>();
                            if (requestLastTurnUI != null)
                            {
                                isProcess = requestLastTurnUI.useShortKey(e);
                            }
                            else
                            {
                                Debug.LogError("requestLastTurnUI null: " + this);
                            }
                        }
                    }
                }
        ...
        public Text lbTitle;
        private static readonly TxtLanguage txtTitle = new TxtLanguage("Last Turn");
