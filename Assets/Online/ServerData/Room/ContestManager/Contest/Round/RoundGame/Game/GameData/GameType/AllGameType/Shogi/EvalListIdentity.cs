...
namespace Shogi
{
	public class EvalListIdentity : DataIdentity
	{
		...
		private void OnList0Changed(SyncList<int>.Operation op, int index, int item)
		{
		...
		private void OnList1Changed(SyncList<int>.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnListToSquareHandChanged(SyncList<int>.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnSquareHandToListChanged(SyncList<System.Int32>.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
