...
namespace Weiqi
{
    public class BoardIdentity : DataIdentity
    {
        ...
        private void OnCapturesChanged(SyncListInt.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnGChanged(SyncListInt.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnPpChanged(SyncListInt.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnPat3Changed(SyncListUInt.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnCChanged(SyncListInt.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnHistory_hashChanged(SyncListUInt64.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
        ...
        private void OnQhashChanged(SyncListUInt64.Operation op, int index)
        {
            if (this.netData.clientData != null)
            {
