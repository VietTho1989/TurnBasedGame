							...
							int lastKeyY = 4;
							{
								...
								if (gameMove != null) {
									...
									case GameMove.Type.SeirawanMove:
										{
											SeirawanMove seirawanMove = gameMove as SeirawanMove;
											int fromX = 0;
											int fromY = 0;
											int destX = 0;
											int destY = 0;
									...
									case GameMove.Type.SeirawanCustomSet:
										{
											...
											lastKeyX = seirawanCustomSet.x.v;
											lastKeyY = seirawanCustomSet.y.v;
										}
										break;
									case GameMove.Type.SeirawanCustomMove:
										{
											...
											lastKeyX = seirawanCustomMove.destX.v;
											lastKeyY = seirawanCustomMove.destY.v;
										}
										break;
