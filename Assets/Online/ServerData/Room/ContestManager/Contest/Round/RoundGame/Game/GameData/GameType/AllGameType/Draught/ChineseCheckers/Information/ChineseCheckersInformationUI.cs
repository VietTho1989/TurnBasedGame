...
{
    public class ChineseCheckersInformationUI : UIHaveTransformDataBehavior<ChineseCheckersInformationUI.UIData>
    {
        ...
        {
            txtMessage.add(Language.Type.vi, "https://en.wikipedia.org/wiki/Chinese_checkers");
        }
