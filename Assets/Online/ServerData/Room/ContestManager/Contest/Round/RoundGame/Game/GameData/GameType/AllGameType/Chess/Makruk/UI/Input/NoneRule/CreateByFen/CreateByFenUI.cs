                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            if (noneRuleInputUIData != null)
                            {
                                ...
                                if (makruk != null)
                                {
                                    currentFen = Core.unityPositionToFen(makruk, Core.CanCorrect);
                                }
                                else
                                {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            MakrukCustomFen makrukCustomFen = new MakrukCustomFen();
                            {
                                makrukCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(makrukCustomFen);
                        }
                        else
                        {
