	...
	public override void onUpdateSync<T> (WrapProperty wrapProperty, List<Sync<T>> syncs)
	{
		...
		// CheckChange
		{
			...
			if (wrapProperty.p is GameCheckPlayerChange<WaitInputAction>) {
				switch ((GameCheckPlayerChange<WaitInputAction>.Property)wrapProperty.n) {
				case GameCheckPlayerChange<WaitInputAction>.Property.change:
					dirty = true;
					break;
				default:
					Debug.LogError ("unknown wrapProperty: " + wrapProperty + "; " + this);
			...
			if (wrapProperty.p is RoomCheckChangeAdminChange<WaitInputAction>) {
				switch ((RoomCheckChangeAdminChange<WaitInputAction>.Property)wrapProperty.n) {
				case RoomCheckChangeAdminChange<WaitInputAction>.Property.change:
					dirty = true;
					break;
				default:
					Debug.LogError ("unknown wrapProperty: " + wrapProperty + "; " + this);
