...
public class GamePlayerStateSurrenderAsk : GamePlayerStateSurrender.State
{
    ...
    public void accept(uint userId)
    {
        if (isCanAccept(userId))
        {
            ...
            // add message
            GamePlayerStateMessage.Add(this, userId, GamePlayer.GetPlayerIndex(this), GamePlayerStateMessage.Action.AcceptCancel);
        }
        else
        {
    ...
    public void refuse(uint userId)
    {
        if (isCanRefuse(userId))
        {
            ...
            {
                // add message
                GamePlayerStateMessage.Add(this, userId, GamePlayer.GetPlayerIndex(this), GamePlayerStateMessage.Action.RefuseCancel);
                // change state
