...
public class RequestChangeBlindFold : Data
{
    ...
    public RequestChangeBlindFold() : base()
    {
        this.state = new VP<State>(this, (byte)Property.state, new RequestChangeBlindFoldStateNone());
