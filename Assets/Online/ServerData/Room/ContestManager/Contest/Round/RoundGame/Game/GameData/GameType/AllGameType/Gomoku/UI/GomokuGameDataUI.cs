...
namespace Gomoku
{
    public class GomokuGameDataUI : UIHaveTransformDataBehavior<GomokuGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    Gomoku gomoku = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    gomoku = (Gomoku)gameType;
                                }
                                else
                                {
                                    Debug.LogError("why not gomoku: " + this);
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.gomoku.v = new ReferenceData<Gomoku>(gomoku);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.gomoku.v = new ReferenceData<Gomoku>(gomoku);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
