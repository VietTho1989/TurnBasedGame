                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                ...
                                case GameMove.Type.KhetCustomFen:
                                    {
                                        KhetCustomFen khetCustomFen = hintMove as KhetCustomFen;
                                        // Find
                                        KhetCustomFenUI.UIData khetCustomFenUIData = this.data.sub.newOrOld<KhetCustomFenUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            khetCustomFenUIData.isHint.v = true;
                                        }
            ...
            if (data is LastMoveSub)
            {
                ...
                // UI
                {
                    switch (sub.getType())
                    {
                        ...
                        case GameMove.Type.KhetCustomFen:
                            {
                                KhetCustomFenUI.UIData khetCustomFenUIData = sub as KhetCustomFenUI.UIData;
