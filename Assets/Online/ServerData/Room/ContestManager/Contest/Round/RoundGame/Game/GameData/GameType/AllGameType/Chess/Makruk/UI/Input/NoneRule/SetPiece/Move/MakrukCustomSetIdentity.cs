...
{
	public class MakrukCustomSetIdentity : DataIdentity
	{
		...
		private NetData<MakrukCustomSet> netData = new NetData<MakrukCustomSet>();
		...
		public override void onAddCallBack<T> (T data)
		{
			if (data is MakrukCustomSet) {
				MakrukCustomSet makrukCustomSet = data as MakrukCustomSet;
				// Set new parent
				this.addTransformToParent();
				// Set property
				{
					this.serialize (this.searchInfor, makrukCustomSet.makeSearchInforms ());
					this.x = makrukCustomSet.x.v;
					this.y = makrukCustomSet.y.v;
					this.piece = makrukCustomSet.piece.v;
				}
				// Observer
				{
					...
					if (observer != null) {
						...
						observer.setCheckChangeData (makrukCustomSet);
					} else {
