                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            if (noneRuleInputUIData != null)
                            {
                                ...
                                if (fairyChess != null)
                                {
                                    currentFen = Core.unityGetPositionFen(fairyChess, Core.CanCorrect);
                                }
                                else
                                {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            FairyChessCustomFen fairyChessCustomFen = new FairyChessCustomFen();
                            {
                                fairyChessCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(fairyChessCustomFen);
                        }
                        else
                        {
