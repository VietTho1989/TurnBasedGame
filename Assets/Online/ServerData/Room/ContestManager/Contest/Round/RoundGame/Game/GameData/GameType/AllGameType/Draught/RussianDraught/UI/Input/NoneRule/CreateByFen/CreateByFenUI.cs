                ...
                if (this.data != null)
                {
                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            {
                                RussianDraught russianDraught = noneRuleInputUIData.russianDraught.v.data;
                                if (russianDraught != null)
                                {
                                    currentFen = Core.unityPositionToFen(russianDraught, Core.CanCorrect);
                                }
                                else
                                {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            RussianDraughtCustomFen russianDraughtCustomFen = new RussianDraughtCustomFen();
                            {
                                russianDraughtCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(russianDraughtCustomFen);
                        }
                        else
                        {
