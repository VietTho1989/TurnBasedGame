...
namespace FairyChess
{
	public class FairyChessIdentity : DataIdentity
	{
		...
		private void OnUnpromotedBoardChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnCastlingPathChanged(SyncListUInt64.Operation op, int index, MyUInt64 item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnPieceCountInHandChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
