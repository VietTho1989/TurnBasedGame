                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                ...
                                case GameMove.Type.XiangqiCustomFen:
                                    {
                                        XiangqiCustomFen xiangqiCustomFen = hintMove as XiangqiCustomFen;
                                        // Find
                                        XiangqiCustomFenUI.UIData xiangqiCustomFenUIData = this.data.sub.newOrOld<XiangqiCustomFenUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            xiangqiCustomFenUIData.isHint.v = true;
                                        }
                ...
                if (data is LastMoveSub)
                {
                    ...
                    // UI
                    {
                        switch (sub.getType())
                        {
                            ...
                            case GameMove.Type.XiangqiCustomFen:
                                {
                                    XiangqiCustomFenUI.UIData xiangqiCustomFenUIData = sub as XiangqiCustomFenUI.UIData;
