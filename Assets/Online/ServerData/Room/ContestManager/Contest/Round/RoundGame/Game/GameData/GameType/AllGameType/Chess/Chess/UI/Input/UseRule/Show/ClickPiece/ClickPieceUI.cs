							...
							int lastKeyY = 4;
							{
								...
								if (gameMove != null) {
									...
									case GameMove.Type.ChessCustomSet:
										{
											NoneRule.ChessCustomSet chessCustomSet = gameMove as NoneRule.ChessCustomSet;
											lastKeyX = chessCustomSet.x.v;
											lastKeyY = chessCustomSet.y.v;
										}
										break;
									case GameMove.Type.ChessCustomMove:
										{
											NoneRule.ChessCustomMove chessCustomMove = gameMove as NoneRule.ChessCustomMove;
											lastKeyX = chessCustomMove.destX.v;
											lastKeyY = chessCustomMove.destY.v;
										}
										break;
