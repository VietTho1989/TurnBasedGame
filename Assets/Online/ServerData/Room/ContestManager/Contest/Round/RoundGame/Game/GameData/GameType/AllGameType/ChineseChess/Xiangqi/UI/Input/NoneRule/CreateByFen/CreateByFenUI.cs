                ...
                if (this.data != null)
                {
                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            {
                                Xiangqi xiangqi = noneRuleInputUIData.xiangqi.v.data;
                                if (xiangqi != null)
                                {
                                    currentFen = Common.printPositionFen(xiangqi);
                                }
                                else
                                {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            XiangqiCustomFen xiangqiCustomFen = new XiangqiCustomFen();
                            {
                                xiangqiCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(xiangqiCustomFen);
                        }
                        else
                        {
