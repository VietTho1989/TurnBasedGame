...
namespace Rubiks
{
    public class RubiksGameDataUI : UIHaveTransformDataBehavior<RubiksGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    Rubiks rubiks = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                if (gameType is Rubiks)
                                {
                                    rubiks = gameType as Rubiks;
                                }
                                else
                                {
                                    Debug.LogError("why not rubiks");
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.rubiks.v = new ReferenceData<Rubiks>(rubiks);
                            }
                            else
                            {
                        ...
                        /*{
                            ...
                            {
                                this.data.inputUI.v.chess.v = new ReferenceData<Chess>(chess);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
