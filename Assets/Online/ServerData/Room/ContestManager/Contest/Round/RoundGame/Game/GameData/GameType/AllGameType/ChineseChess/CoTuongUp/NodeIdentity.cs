...
namespace CoTuongUp
{
	public class NodeIdentity : DataIdentity
	{
		...
		private void OnPiecesChanged(SyncListByte.Operation op, int index, MyByte item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnCapturesChanged(SyncListByte.Operation op, int index, MyByte item)
		{
			if (this.netData.clientData != null) {
