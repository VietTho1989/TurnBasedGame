                ...
                if (this.data != null)
                {
                    ...
                    if (firstInit)
                    {
                        ...
                        string currentFen = "";
                        {
                            ...
                            if (noneRuleInputUIData != null)
                            {
                                ...
                                if (shogi != null)
                                {
                                    currentFen = Common.positionToFen(shogi);
                                }
                                else
                                {
                    ...
                    // txt
                    {
                        ...
                        if (edtFen != null)
                        {
                            ...
                            {
                                Debug.LogError("edtFen textComponent null");
                            }
                        }
                        else
                        {
            ...
            if (this.data != null)
            {
                ...
                if (!string.IsNullOrEmpty(strFen))
                {
                    if (strFen.Length <= 100)
                    {
                        ...
                        if (clientInput != null)
                        {
                            ShogiCustomFen shogiCustomFen = new ShogiCustomFen();
                            {
                                shogiCustomFen.fen.v = strFen;
                            }
                            clientInput.makeSend(shogiCustomFen);
                        }
                        else
                        {
