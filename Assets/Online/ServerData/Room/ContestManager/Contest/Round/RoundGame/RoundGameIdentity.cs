...
namespace GameManager.Match
{
	public class RoundGameIdentity : DataIdentity
	{
		...
		private void OnPlayerInTeamChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
		...
		private void OnPlayerInGameChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
