...
namespace InternationalDraught
{
	public class PosIdentity : DataIdentity
	{
		...
		private void OnP_pieceChanged(SyncListUInt64.Operation op, int index, MyUInt64 item)
		{
		...
		private void OnP_sideChanged(SyncListSTRUCT<MyUInt64>.Operation op, int index, MyUInt64 item)
		{
			if (this.netData.clientData != null) {
