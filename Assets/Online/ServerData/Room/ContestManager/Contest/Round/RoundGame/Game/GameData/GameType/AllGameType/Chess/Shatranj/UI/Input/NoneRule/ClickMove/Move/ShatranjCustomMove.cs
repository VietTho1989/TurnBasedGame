...
{
	public class ShatranjCustomMove : GameMove
	{
		...
		public ShatranjCustomMove() : base()
		{
		...
		{
			return Type.ShatranjCustomMove;
		}
		...
		{
			return string.Format ("ShatranjCustomMove: {0}, {1}, {2}, {3}", this.fromX.v, this.fromY.v, this.destX.v, this.destY.v);
		}
