...
namespace Chess
{
    public class ChessGameDataUI : UIHaveTransformDataBehavior<ChessGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    Chess chess = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    chess = gameType as Chess;
                                }
                                else
                                {
                                    Debug.LogError("why not chess");
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.chess.v = new ReferenceData<Chess>(chess);
                            }
                            else
                            {
