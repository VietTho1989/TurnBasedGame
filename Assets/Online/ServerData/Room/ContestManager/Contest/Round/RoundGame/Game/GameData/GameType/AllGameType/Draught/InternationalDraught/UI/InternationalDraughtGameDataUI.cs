...
{
    public class InternationalDraughtGameDataUI : UIHaveTransformDataBehavior<InternationalDraughtGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    InternationalDraught internationalDraught = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    internationalDraught = gameType as InternationalDraught;
                                }
                                else
                                {
                                    Debug.LogError("why not internationalDraught: " + this);
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.internationalDraught.v = new ReferenceData<InternationalDraught>(internationalDraught);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.internationalDraught.v = new ReferenceData<InternationalDraught>(internationalDraught);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
