                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                ...
                                case GameMove.Type.ShogiCustomFen:
                                    {
                                        ShogiCustomFen shogiCustomFen = hintMove as ShogiCustomFen;
                                        // Find
                                        ShogiCustomFenUI.UIData shogiCustomFenUIData = this.data.sub.newOrOld<ShogiCustomFenUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            shogiCustomFenUIData.isHint.v = true;
                                        }
                ...
                if (data is LastMoveSub)
                {
                    LastMoveSub sub = data as LastMoveSub;
                    {
                        switch (sub.getType())
                        {
                            ...
                            case GameMove.Type.ShogiCustomFen:
                                {
                                    ShogiCustomFenUI.UIData shogiCustomFenUIData = sub as ShogiCustomFenUI.UIData;
