    ...
    public class EditPostureGameDataUI : UIBehavior<EditPostureGameDataUI.UIData>
    {
        ...
        public override void Awake()
        {
            ...
            // OnClick
            {
                ...
                UIUtils.SetButtonOnClick(btnPosture, onClickBtnPosture);
            }
        }
            ...
            bool isProcess = false;
            {
                if (e.isKey && e.type == EventType.KeyUp)
                {
                    switch (e.keyCode)
                    {
                        ...
                        case KeyCode.P:
                            {
                                if (btnPosture != null && btnPosture.gameObject.activeInHierarchy && btnPosture.interactable)
                                {
                                    this.onClickBtnPosture();
                                    isProcess = true;
                                }
                                else
                                {
