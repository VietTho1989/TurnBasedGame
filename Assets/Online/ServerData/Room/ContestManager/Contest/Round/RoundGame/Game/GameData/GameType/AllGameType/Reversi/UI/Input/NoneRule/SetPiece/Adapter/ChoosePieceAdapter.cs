				...
				if (this.Initialized) {
					...
					if (this.data != null) {
						...
						// get
						{
							...
							int alreadySelectPiece = Reversi.NONE;
							{
								...
								if (noneRuleInputUIData != null) {
									...
									if (reversi != null) {
										...
										if (setPieceUIData != null) {
											alreadySelectPiece = reversi.getPiece (setPieceUIData.square.v);
										} else {
							...
							{
								int[] CanChosenPieces = { Reversi.NONE, Reversi.WHITE, Reversi.BLACK };
								foreach (int piece in CanChosenPieces) {
