                    ...
                    if (chatMessage != null)
                    {
                        // Find human
                        {
                            ...
                            if (human != null)
                            {
                                ...
                                {
                                    if (human.findDataInParent<ChatRoom>() == undoRedoRequestMessage.findDataInParent<ChatRoom>())
                                    {
                                        if (human.playerId.v == undoRedoRequestMessage.userId.v)
                                        {
                                            isCorrect = true;
                                        }
                                    }
                            ...
                            if (human == null)
                            {
                                human = ChatRoom.findHuman(undoRedoRequestMessage, undoRedoRequestMessage.userId.v);
                                if (human != null)
                                {
