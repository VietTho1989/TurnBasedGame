...
{
    public class MineSweeperGameDataUI : UIHaveTransformDataBehavior<MineSweeperGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    MineSweeper mineSweeper = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    mineSweeper = gameType as MineSweeper;
                                }
                                else
                                {
                                    Debug.LogError("why not mineSweeper");
                                }
                            }
                            else
                            {
                    ...
                    // Process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.mineSweeper.v = new ReferenceData<MineSweeper>(mineSweeper);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.mineSweeper.v = new ReferenceData<MineSweeper>(mineSweeper);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
