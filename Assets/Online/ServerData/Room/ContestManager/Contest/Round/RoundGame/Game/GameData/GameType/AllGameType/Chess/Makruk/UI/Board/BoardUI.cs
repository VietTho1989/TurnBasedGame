            ...
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    ...
                    if (makruk != null)
                    {
                        ...
                        {
                            // Normal board
                            bool blindFold = GameData.IsBlindFold(makruk);
                            {
                                // get olds
                ...
                // makruk
                {
                    if (data is Makruk)
                    {
                        ...
                        // checkChange
                        {
                            ...
                            gameDataCheckChangeBlindFold.setData(makruk);
                        }
                        dirty = true;
                        return;
                    }
                    // checkChange
                    if (data is GameDataCheckChangeBlindFold<Makruk>)
                    {
                        dirty = true;
                        return;
                    }
        ...
        public override void onUpdateSync<T>(WrapProperty wrapProperty, List<Sync<T>> syncs)
        {
            ...
            // Child
            {
                // makruk
                {
                    ...
                    // checkChange
                    if (wrapProperty.p is GameDataCheckChangeBlindFold<Makruk>)
                    {
                        dirty = true;
                        return;
                    }
