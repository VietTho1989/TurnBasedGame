                ...
                if (this.data != null)
                {
                    ...
                    if (coTuongUpCustomSet != null)
                    {
                        ...
                        if (imgHint != null)
                        {
                            ...
                            {
                                // sprite
                                imgHint.sprite = CoTuongUpSpriteContainer.get().getSprite(coTuongUpCustomSet.piece.v, Setting.get().style.v);
                                // position
                                {
                            ...
                            {
                                imgHint.sprite = CoTuongUpSpriteContainer.get().getSprite(Common.x, Setting.get().style.v);
                            }
                        }
                        else
                        {
