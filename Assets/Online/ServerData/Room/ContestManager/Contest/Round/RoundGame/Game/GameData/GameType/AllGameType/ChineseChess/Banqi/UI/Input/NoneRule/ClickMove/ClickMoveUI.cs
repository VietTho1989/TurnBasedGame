                    ...
                    if (x >= 0 && x < 8 && y >= 0 && y < 4)
                    {
                        ...
                        else
                        {
                            ...
                            if (clientInput != null)
                            {
                                ...
                                {
                                    banqiCustomMove.fromX.v = this.data.x.v;
                                    banqiCustomMove.fromY.v = this.data.y.v;
                                    banqiCustomMove.destX.v = x;
                                    banqiCustomMove.destY.v = y;
                                }
                                clientInput.makeSend(banqiCustomMove);
                            }
                            else
                            {
