        ...
        public override void refresh()
        {
            ...
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    ...
                    ChineseCheckers chineseCheckers = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                if (gameType is ChineseCheckers)
                                {
                                    chineseCheckers = (ChineseCheckers)gameType;
                                }
                                else
                                {
                                    Debug.LogError("why not chineseCheckers: " + this);
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.chineseCheckers.v = new ReferenceData<ChineseCheckers>(chineseCheckers);
                            }
                            else
                            {
                        ...
                        /*{
                            ...
                            {
                                this.data.inputUI.v.chineseCheckers.v = new ReferenceData<ChineseCheckers>(chineseCheckers);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
