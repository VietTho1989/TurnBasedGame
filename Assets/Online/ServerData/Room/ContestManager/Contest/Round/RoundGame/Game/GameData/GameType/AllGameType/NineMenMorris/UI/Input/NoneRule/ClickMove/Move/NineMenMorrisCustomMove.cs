...
{
	public class NineMenMorrisCustomMove : GameMove
	{
		...
		public NineMenMorrisCustomMove() : base()
		{
		...
		{
			return Type.NineMenMorrisCustomMove;
		}
		...
		{
			return string.Format ("NineMenMorrisCustomMove: {0}, {1}, {2}, {3}", this.fromX.v, this.fromY.v, this.destX.v, this.destY.v);
		}
