...
namespace Seirawan
{
    public class SeirawanGameDataUI : UIHaveTransformDataBehavior<SeirawanGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    Seirawan seirawan = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                ...
                                {
                                    seirawan = gameType as Seirawan;
                                }
                                else
                                {
                                    Debug.LogError("why not seirawan");
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.seirawan.v = new ReferenceData<Seirawan>(seirawan);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.seirawan.v = new ReferenceData<Seirawan>(seirawan);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
