...
{
	public class FairyChessCustomMove : GameMove
	{
		...
		public FairyChessCustomMove() : base()
		{
		...
		{
			return Type.FairyChessCustomMove;
		}
		...
		{
			return string.Format ("FairyChessCustomMove: {0}, {1}, {2}, {3}", this.fromX.v, this.fromY.v, this.destX.v, this.destY.v);
		}
