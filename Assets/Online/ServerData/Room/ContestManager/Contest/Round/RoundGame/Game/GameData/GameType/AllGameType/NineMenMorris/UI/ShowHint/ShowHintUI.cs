                        ...
                        if (hintMove != null)
                        {
                            switch (hintMove.getType())
                            {
                                ...
                                case GameMove.Type.NineMenMorrisCustomMove:
                                    {
                                        NineMenMorrisCustomMove nineMenMorrisCustomMove = hintMove as NineMenMorrisCustomMove;
                                        // Find
                                        NineMenMorrisCustomMoveUI.UIData nineMenMorrisCustomMoveUIData = this.data.sub.newOrOld<NineMenMorrisCustomMoveUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            nineMenMorrisCustomMoveUIData.isHint.v = true;
                                        }
                                ...
                                case GameMove.Type.NineMenMorrisCustomSet:
                                    {
                                        NineMenMorrisCustomSet nineMenMorrisCustomSet = hintMove as NineMenMorrisCustomSet;
                                        // Find
                                        NineMenMorrisCustomSetUI.UIData nineMenMorrisCustomSetUIData = this.data.sub.newOrOld<NineMenMorrisCustomSetUI.UIData>();
                                        {
                                            ...
                                            // isHint
                                            nineMenMorrisCustomSetUIData.isHint.v = true;
                                        }
                ...
                if (data is LastMoveSub)
                {
                    ...
                    // UI
                    {
                        switch (sub.getType())
                        {
                            ...
                            case GameMove.Type.NineMenMorrisCustomMove:
                                {
                                    NineMenMorrisCustomMoveUI.UIData nineMenMorrisCustomMoveUIData = sub as NineMenMorrisCustomMoveUI.UIData;
                                    UIUtils.Instantiate(nineMenMorrisCustomMoveUIData, nineMenMorrisCustomMovePrefab, this.transform);
                                }
                                break;
                            case GameMove.Type.NineMenMorrisCustomSet:
                                {
                                    NineMenMorrisCustomSetUI.UIData nineMenMorrisCustomSetUIData = sub as NineMenMorrisCustomSetUI.UIData;
