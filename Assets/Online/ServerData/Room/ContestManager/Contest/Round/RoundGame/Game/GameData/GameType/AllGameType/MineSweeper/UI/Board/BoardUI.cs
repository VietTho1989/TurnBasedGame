...
namespace MineSweeper
{
	public class BoardUI : UIBehavior<BoardUI.UIData>
	{
		...
		public class UIData : Data
		{
			...
			public VP<BackgroundUI.UIData> background;
			...
			public UIData() : base()
			{
				...
				this.background = new VP<BackgroundUI.UIData>(this, (byte)Property.background, new BackgroundUI.UIData());
		...
		public BackgroundUI backgroundPrefab;
		...
		public override void onAddCallBack<T> (T data)
		{
			...
			// Child
			{
				...
				if (data is BackgroundUI.UIData) {
					BackgroundUI.UIData backgroundUIData = data as BackgroundUI.UIData;
					// UI
					{
						UIUtils.Instantiate (backgroundUIData, backgroundPrefab, backgroundContainer);
					}
					dirty = true;
					return;
				}
				if (data is BoundaryUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (boundaryUIData, boundaryPrefab, boundaryContainer);
					}
					dirty = true;
					return;
				}
				if (data is ScrollViewUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (scrollViewUIData, scrollViewPrefab, scrollViewContainer);
					}
					dirty = true;
					return;
				}
		...
		public override void onRemoveCallBack<T> (T data, bool isHide)
		{
			...
			// Child
			{
				...
				if (data is BackgroundUI.UIData) {
					...
					// UI
					{
						backgroundUIData.removeCallBackAndDestroy (typeof(BackgroundUI));
					}
					return;
				}
				if (data is BoundaryUI.UIData) {
		...
		public override void onUpdateSync<T> (WrapProperty wrapProperty, List<Sync<T>> syncs)
		{
			...
			// Child
			{
				...
				if (wrapProperty.p is BackgroundUI.UIData) {
					return;
				}
