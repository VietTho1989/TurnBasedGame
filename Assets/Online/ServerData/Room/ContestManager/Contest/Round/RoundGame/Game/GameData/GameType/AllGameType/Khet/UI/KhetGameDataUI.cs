...
namespace Khet
{
    public class KhetGameDataUI : UIHaveTransformDataBehavior<KhetGameDataUI.UIData>
    {
                ...
                if (this.data != null)
                {
                    ...
                    Khet khet = null;
                    {
                        ...
                        if (gameData != null)
                        {
                            ...
                            if (gameType != null)
                            {
                                if (gameType is Khet)
                                {
                                    khet = gameType as Khet;
                                }
                                else
                                {
                                    Debug.LogError("why not khet");
                                }
                            }
                            else
                            {
                    ...
                    // process
                    {
                        // board
                        {
                            ...
                            {
                                this.data.board.v.khet.v = new ReferenceData<Khet>(khet);
                            }
                            else
                            {
                        ...
                        // input
                        {
                            ...
                            {
                                this.data.inputUI.v.khet.v = new ReferenceData<Khet>(khet);
                            }
                            else
                            {
                                Debug.LogError("inputUI null: " + this);
