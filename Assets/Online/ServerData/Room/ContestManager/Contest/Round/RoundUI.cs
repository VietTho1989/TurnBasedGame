...
namespace GameManager.Match
{
	public class RoundUI : UIBehavior<RoundUI.UIData>
	{
		...
		public Transform roundGameContainer;

		public ChooseRoundGameUI chooseRoundGamePrefab;
		public Transform chooseRoundGameContainer;
		...
		public override void onAddCallBack<T> (T data)
		{
			...
			// Child
			{
				...
				if (data is RoundGameUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (roundGameUIData, roundGamePrefab, roundGameContainer);
					}
					dirty = true;
					return;
				}
				if (data is ChooseRoundGameUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (chooseRoundGameUIData, chooseRoundGamePrefab, chooseRoundGameContainer);
					}
					dirty = true;
					return;
				}
