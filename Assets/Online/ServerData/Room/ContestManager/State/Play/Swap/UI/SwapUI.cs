...
namespace GameManager.Match.Swap
{
	public class SwapUI : UIBehavior<SwapUI.UIData>
	{
		...
		public Transform swapTeamAdapterContainer;

		public SwapPlayerInformUI swapPlayerInformPrefab;
		public Transform swapPlayerInformContainer;
		...
		public override void onAddCallBack<T> (T data)
		{
			...
			// Child
			{
				...
				if (data is SwapTeamAdapter.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (swapTeamAdapterUIData, swapTeamAdapterPrefab, swapTeamAdapterContainer);
					}
					dirty = true;
					return;
				}
				if (data is SwapPlayerInformUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (swapPlayerInformUIData, swapPlayerInformPrefab, swapPlayerInformContainer);
					}
					dirty = true;
					return;
				}
