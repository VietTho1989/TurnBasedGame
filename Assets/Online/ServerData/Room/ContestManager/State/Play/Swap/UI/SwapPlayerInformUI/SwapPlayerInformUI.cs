					...
					if (teamPlayer != null) {
						...
						int playerIndex = teamPlayer.playerIndex.v;
						{
							if (tvPlayerIndex != null) {
								tvPlayerIndex.text = "PlayerIndex: " + playerIndex;
							} else {
						...
						int teamIndex = 0;
						{
							if (tvTeamIndex != null) {
								...
								tvTeamIndex.text = "TeamIndex: " + teamIndex;
							} else {
						...
						case UIData.Sub.Type.NoRequest:
							{
								...
								UIUtils.Instantiate (noRequestSwapPlayerUIData, noRequestSwapPlayerPrefab, subContainer);
							}
							break;
						case UIData.Sub.Type.HaveRequest:
							{
								...
								UIUtils.Instantiate (haveRequestSwapPlayerUIData, haveRequestSwapPlayerPrefab, subContainer);
							}
							break;
						default:
