...
namespace GameManager.Match
{
	public class LobbyBtnStart : UIBehavior<LobbyBtnStart.UIData>
	{
		...
		public static readonly TxtLanguage txtCancelStart = new TxtLanguage ();
		public static readonly TxtLanguage txtStarting = new TxtLanguage ();
		public static readonly TxtLanguage txtNotAllReady = new TxtLanguage ();

		public static readonly TxtLanguage txtStartingTime = new TxtLanguage ();
