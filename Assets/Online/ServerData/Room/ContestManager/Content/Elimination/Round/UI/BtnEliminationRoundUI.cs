...
namespace GameManager.Match.Elimination
{
    public class BtnEliminationRoundUI : UIHaveTransformDataBehavior<BtnEliminationRoundUI.UIData>
    {
        ...
        public override void Awake()
        {
            ...
            // OnClick
            {
                UIUtils.SetButtonOnClick(btnEliminationRound, onClickBtnEliminationRound);
            }
        }
            ...
            bool isProcess = false;
            {
                if (e.isKey && e.type == EventType.KeyUp)
                {
                    switch (e.keyCode)
                    {
                        case KeyCode.R:
                            {
                                if (btnEliminationRound != null && btnEliminationRound.gameObject.activeInHierarchy && btnEliminationRound.interactable)
                                {
                                    this.onClickBtnEliminationRound();
                                    isProcess = true;
                                }
                                else
                                {
        ...
        public Button btnEliminationRound;
