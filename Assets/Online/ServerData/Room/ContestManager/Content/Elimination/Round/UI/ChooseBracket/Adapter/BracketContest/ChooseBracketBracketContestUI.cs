...
{
	public class ChooseBracketBracketContestUI : UIBehavior<ChooseBracketBracketContestUI.UIData>
	{
		...
		{
			txtContest.add (Language.Type.vi, "Trận đấu");
			...
			if (dirty) {
				...
				if (this.data != null) {
					...
					if (bracketContest != null) {
						...
						{
							if (tvIndex != null) {
								tvIndex.text = txtContest.get ("Contest") + ": " + bracketContest.index.v;
							} else {
