...
namespace GameManager.Match.Elimination
{
	public class BracketStateEndIdentity : DataIdentity
	{
		...
		private void OnWinTeamIndexsChanged(SyncListInt.Operation op, int index, int item)
		{
		...
		private void OnLoseTeamIndexsChanged(SyncListInt.Operation op, int index, int item)
		{
			if (this.netData.clientData != null) {
