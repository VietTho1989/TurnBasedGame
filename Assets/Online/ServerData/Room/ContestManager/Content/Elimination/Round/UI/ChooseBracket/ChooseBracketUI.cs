...
namespace GameManager.Match.Elimination
{
    public class ChooseBracketUI : UIBehavior<ChooseBracketUI.UIData>
    {
        ...
        private static readonly UIRectTransform chooseBracketAdapterRect = UIRectTransform.CreateFullRect(0, 0, 30, 0);
        ...
        public override void onAddCallBack<T>(T data)
        {
            ...
            // Child
            {
                ...
                if (data is ChooseBracketAdapter.UIData)
                {
                    ...
                    // UI
                    {
                        UIUtils.Instantiate(chooseBracketAdapterUIData, chooseBracketAdapterPrefab, this.transform, chooseBracketAdapterRect);
                    }
                    dirty = true;
                    return;
                }
