            ...
            if (dirty)
            {
                ...
                if (this.data != null)
                {
                    ...
                    if (bracket != null)
                    {
                        ...
                        // siblingIndex
                        {
                            UIRectTransform.SetSiblingIndex(this.data.bracketContestUIData.v, 0);
                            if (noBracketContest != null)
                            {
                                noBracketContest.transform.SetSiblingIndex(1);
                            }
                            else
                            {
                                Debug.LogError("noBracketContest null");
                            }
                            UIRectTransform.SetSiblingIndex(this.data.chooseBracketContestUIData.v, 2);
                        }
                        // txt
                        {
