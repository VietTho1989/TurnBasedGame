...
{
    public class BtnBracketUI : UIHaveTransformDataBehavior<BtnBracketUI.UIData>
    {
            ...
            public bool processEvent(Event e)
            {
                bool isProcess = false;
                {
                    ...
                    if (!isProcess)
                    {
                        ...
                        {
                            BtnBracketUI btnBracketUI = this.findCallBack<BtnBracketUI>();
                            if (btnBracketUI != null)
                            {
                                isProcess = btnBracketUI.useShortKey(e);
                            }
                            else
                            {
                                Debug.LogError("btnBracketUI null: " + this);
                            }
                        }
                    }
                }
        ...
        private static readonly TxtLanguage txtBracket = new TxtLanguage("Bracket match");
                    ...
                    if (bracketUIData != null)
                    {
                        // tvBracket
                        {
                            if (tvBracket != null)
                            {
                                ...
                                tvBracket.text = txtBracket.get() + " " + (bracketContestIndex + 1) + "/" + bracketContestCount;
                            }
                            else
                            {
        ...
        public override void Awake()
        {
            ...
            // OnClick
            {
                UIUtils.SetButtonOnClick(btnBracket, onClickBtnBracket);
            }
        }
