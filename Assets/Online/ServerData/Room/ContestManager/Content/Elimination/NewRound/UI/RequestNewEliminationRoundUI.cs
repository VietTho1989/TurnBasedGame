                            ...
                            case RequestNewEliminationRound.State.Type.None:
                                {
                                    ...
                                    UIUtils.Instantiate(requestNewEliminationRoundStateNone, nonePrefab, this.transform, UIConstants.FullParent);
                                }
                                break;
                            case RequestNewEliminationRound.State.Type.Ask:
                                {
                                    ...
                                    UIUtils.Instantiate(requestNewEliminationRoundStateAsk, askPrefab, this.transform, UIConstants.FullParent);
                                }
                                break;
                            case RequestNewEliminationRound.State.Type.Accept:
                                {
                                    ...
                                    UIUtils.Instantiate(requestNewEliminationRoundStateAccept, acceptPrefab, this.transform, UIConstants.FullParent);
                                }
                                break;
                            default:
