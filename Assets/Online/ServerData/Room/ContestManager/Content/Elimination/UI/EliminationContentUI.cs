...
namespace GameManager.Match.Elimination
{
	public class EliminationContentUI : UIBehavior<EliminationContentUI.UIData>
	{
		...
		public Transform eliminationRoundContainer;

		public ChooseEliminationRoundUI chooseEliminationRoundPrefab;
		public Transform chooseEliminationRoundContainer;

		public RequestNewEliminationRoundUI requestNewEliminationRoundPrefab;
		public Transform requestNewEliminationRoundContainer;
		...
		public override void onAddCallBack<T> (T data)
		{
			...
			// Child
			{
				...
				if (data is EliminationRoundUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (eliminationRoundUIData, eliminationRoundPrefab, eliminationRoundContainer);
					}
					dirty = true;
					return;
				}
				if (data is ChooseEliminationRoundUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (chooseEliminationRoundUIData, chooseEliminationRoundPrefab, chooseEliminationRoundContainer);
					}
					dirty = true;
					return;
				}
				if (data is RequestNewEliminationRoundUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (requestNewEliminationRoundUIData, requestNewEliminationRoundPrefab, requestNewEliminationRoundContainer);
					}
					dirty = true;
					return;
				}
