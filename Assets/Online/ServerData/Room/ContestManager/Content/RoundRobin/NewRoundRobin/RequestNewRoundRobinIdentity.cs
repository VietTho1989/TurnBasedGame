...
{
	public class RequestNewRoundRobinIdentity : DataIdentity
	{
		...
		private NetData<RequestNewRoundRobin> netData = new NetData<RequestNewRoundRobin>();
		...
		public override void onAddCallBack<T> (T data)
		{
			if (data is RequestNewRoundRobin) {
				...
				// Set property
				{
					this.serialize (this.searchInfor, requestNewRoundRobin.makeSearchInforms ());
				}
				// Observer
				{
					...
					if (observer != null) {
						...
						observer.setCheckChangeData (requestNewRoundRobin);
					} else {
