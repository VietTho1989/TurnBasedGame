...
namespace GameManager.Match.RoundRobin
{
	public class ChooseRoundContestUI : UIBehavior<ChooseRoundContestUI.UIData>
	{
		...
		public Transform chooseRoundContestAdapterContainer;
		...
		public override void onAddCallBack<T> (T data)
		{
			...
			// Child
			{
				...
				if (data is ChooseRoundContestAdapter.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (chooseRoundContestAdapterUIData, chooseRoundContestAdapterPrefab, chooseRoundContestAdapterContainer);
					}
					dirty = true;
					return;
				}
