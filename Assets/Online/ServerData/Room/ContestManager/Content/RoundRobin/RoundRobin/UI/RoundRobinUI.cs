...
namespace GameManager.Match.RoundRobin
{
	public class RoundRobinUI : UIBehavior<RoundRobinUI.UIData>
	{
		...
		public Transform roundContestContainer;

		public ChooseRoundContestUI chooseRoundContestPrefab;
		public Transform chooseRoundContestContainer;
		...
		public override void onAddCallBack<T> (T data)
		{
			...
			// Child
			{
				...
				if (data is RoundContestUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (roundContestUIData, roundContestPrefab, roundContestContainer);
					}
					dirty = true;
					return;
				}
				if (data is ChooseRoundContestUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (chooseRoundContestUIData, chooseRoundContestPrefab, chooseRoundContestContainer);
					}
					dirty = true;
					return;
				}
