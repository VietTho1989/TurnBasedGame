...
{
	public class RoundRobinIdentity : DataIdentity
	{
		...
		#region roundContests

		[SyncVar]
		public int roundContests;
		...
		private NetData<RoundRobin> netData = new NetData<RoundRobin>();
		...
		public override void onAddCallBack<T> (T data)
		{
			if (data is RoundRobin) {
				...
				// Set property
				{
					this.serialize (this.searchInfor, roundRobin.makeSearchInforms ());
					this.index = roundRobin.index.v;
					this.roundContests = roundRobin.roundContests.vs.Count;
				}
				// Observer
				{
					...
					if (observer != null) {
						...
						observer.setCheckChangeData (roundRobin);
					} else {
		...
		public override void onUpdateSync<T> (WrapProperty wrapProperty, List<Sync<T>> syncs)
		{
			...
			if (wrapProperty.p is RoundRobin) {
				...
				case RoundRobin.Property.roundContests:
					{
						RoundRobin roundRobin = wrapProperty.p as RoundRobin;
						this.roundContests = roundRobin.roundContests.vs.Count;
					}
					break;
				default:
