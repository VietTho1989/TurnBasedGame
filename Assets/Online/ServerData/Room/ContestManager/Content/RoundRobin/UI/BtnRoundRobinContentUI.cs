...
{
	public class BtnRoundRobinContentUI : UIBehavior<BtnRoundRobinContentUI.UIData>
	{
					...
					if (roundRobinContentUIData != null) {
						// tvRoundRobinContent
						{
							if (tvRoundRobinContent != null) {
								...
								tvRoundRobinContent.text = txtRoundRobinContent.get ("RoundRobin") + " " + roundRobinIndex + "/" + roundRobinCount;
							} else {
