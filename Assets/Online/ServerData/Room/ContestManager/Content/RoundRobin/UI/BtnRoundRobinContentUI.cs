...
namespace GameManager.Match.RoundRobin
{
    public class BtnRoundRobinContentUI : UIHaveTransformDataBehavior<BtnRoundRobinContentUI.UIData>
    {
        ...
        public override void Awake()
        {
            ...
            // OnClick
            {
                UIUtils.SetButtonOnClick(btnRoundRobinContent, onClickBtnRoundRobinContent);
            }
        }
            ...
            bool isProcess = false;
            {
                if (e.isKey && e.type == EventType.KeyUp)
                {
                    switch (e.keyCode)
                    {
                        case KeyCode.R:
                            {
                                if (btnRoundRobinContent != null && btnRoundRobinContent.gameObject.activeInHierarchy && btnRoundRobinContent.interactable)
                                {
                                    this.onClickBtnRoundRobinContent();
                                    isProcess = true;
                                }
                                else
                                {
        ...
        public Button btnRoundRobinContent;
