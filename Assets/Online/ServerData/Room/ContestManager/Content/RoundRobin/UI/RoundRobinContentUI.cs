...
namespace GameManager.Match.RoundRobin
{
	public class RoundRobinContentUI : UIBehavior<RoundRobinContentUI.UIData>
	{
		...
		public Transform roundRobinContainer;

		public ChooseRoundRobinUI chooseRoundRobinPrefab;
		public Transform chooseRoundRobinContainer;

		public RequestNewRoundRobinUI requestNewRoundRobinPrefab;
		public Transform requestNewRoundRobinContainer;
		...
		public override void onAddCallBack<T> (T data)
		{
			...
			// Child
			{
				...
				if (data is RoundRobinUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (roundRobinUIData, roundRobinPrefab, roundRobinContainer);
					}
					dirty = true;
					return;
				}
				if (data is ChooseRoundRobinUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (chooseRoundRobinUIData, chooseRoundRobinPrefab, chooseRoundRobinContainer);
					}
					dirty = true;
					return;
				}
				if (data is RequestNewRoundRobinUI.UIData) {
					...
					// UI
					{
						UIUtils.Instantiate (requestNewRoundRobinUIData, requestNewRoundRobinPrefab, requestNewRoundRobinContainer);
					}
					dirty = true;
					return;
				}
